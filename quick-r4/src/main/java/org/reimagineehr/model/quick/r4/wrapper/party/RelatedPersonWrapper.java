...
public class RelatedPersonWrapper implements RelatedPerson {
	...
	private org.hl7.fhir.r4.model.RelatedPerson adaptee;

	public RelatedPersonWrapper() {
	
	}

	public RelatedPersonWrapper(org.hl7.fhir.r4.model.RelatedPerson adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.RelatedPerson getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.RelatedPerson arg) {
		this.adaptee=arg;
	}
	...
	public List<CodeableConcept> getRelationship() {
		...
		org.reimagineehr.model.quick.api.datatype.CodeableConcept codeableConcept = org.reimagineehr.model.quick.r4.utils.R4Utils.getAsQuickCodeableConcept(this.adaptee.getRelationship());
	...
	public void setRelationship(java.util.List<CodeableConcept> arg) {
		if(arg != null && arg.size() > 0) {
			if(arg.size() == 1) {
				this.adaptee.setRelationship(org.reimagineehr.model.quick.r4.utils.R4Utils.getAsFhirCodeableConcept(arg.get(0)));
			} else {
