...
public class TimingRepeatWrapper implements TimingRepeat {
	...
	private org.hl7.fhir.r4.model.Timing.TimingRepeatComponent adaptee;

	public TimingRepeatWrapper() {
	
	}

	public TimingRepeatWrapper(org.hl7.fhir.r4.model.Timing.TimingRepeatComponent adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Timing.TimingRepeatComponent getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Timing.TimingRepeatComponent arg) {
		this.adaptee=arg;
	}
	...
	public TimeIntervalChoice getBounds() {
		...
		Object choice = null;
		org.hl7.fhir.r4.model.Type type = this.adaptee.getBounds();
		if(type instanceof org.hl7.fhir.r4.model.Duration) {
			choice = new org.reimagineehr.model.quick.r4.wrapper.datatype.DurationWrapper((org.hl7.fhir.r4.model.Duration)type);
	...
	public void setBounds(TimeIntervalChoice arg) {
		...
		if(choice.getDuration() != null) {
			this.adaptee.setBounds(((org.reimagineehr.model.quick.r4.wrapper.datatype.DurationWrapper)choice.getDuration()).getAdaptee());
		}else if(choice.getRange() != null) {
			this.adaptee.setBounds(((org.reimagineehr.model.quick.r4.wrapper.datatype.RangeWrapper)choice.getRange()).getAdaptee());
		}else if(choice.getPeriod() != null) {
			this.adaptee.setBounds(((org.reimagineehr.model.quick.r4.wrapper.datatype.PeriodWrapper)choice.getPeriod()).getAdaptee());
		}
	}
	...
	public void setDurationUnit(String arg) {
		if (arg != null) {
			this.adaptee.setDurationUnit(org.hl7.fhir.r4.model.Timing.UnitsOfTime.fromCode(arg));
		}
	}
	...
	public void setPeriodUnit(String arg) {
		if (arg != null) {
			this.adaptee.setPeriodUnit(org.hl7.fhir.r4.model.Timing.UnitsOfTime.fromCode(arg));
		}
	}
	...
	public List<String> getDayOfWeek() {
		...
		if(this.adaptee.getDayOfWeek() != null) {
			for(org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.Timing.DayOfWeek> type: this.adaptee.getDayOfWeek()) {
	...
	public void setDayOfWeek(java.util.List<String> arg) {
		java.util.List<org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.Timing.DayOfWeek>> values = new java.util.ArrayList<>();
		if(arg != null) {
			for(String type: arg) {
				values.add((new org.hl7.fhir.r4.model.Timing.DayOfWeekEnumFactory()).fromType(new org.hl7.fhir.r4.model.CodeType(type)));
			}
		}
	...
	this.adaptee.addDayOfWeek(org.hl7.fhir.r4.model.Timing.DayOfWeek.fromCode(arg));
	}
	...
	public List<LocalTime> getTimeOfDay() {
		...
		if(this.adaptee.getTimeOfDay() != null) {
			for(org.hl7.fhir.r4.model.TimeType type: this.adaptee.getTimeOfDay()) {
	...
	public void setTimeOfDay(java.util.List<LocalTime> arg) {
		...
		java.util.List<org.hl7.fhir.r4.model.TimeType> values = new java.util.ArrayList<>();
		if(arg != null) {
			for(LocalTime type: arg) {
				values.add(new org.hl7.fhir.r4.model.TimeType(type.toString()));
			}
		}
	...
	public List<String> getWhen() {
		...
		if(this.adaptee.getWhen() != null) {
			for(org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.Timing.EventTiming> type: this.adaptee.getWhen()) {
				retVals.add(type.getValueAsString());
			}
		}return retVals;
	}
	...
	public void setWhen(java.util.List<String> arg) {
		java.util.List<org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.Timing.EventTiming>> values = new java.util.ArrayList<>();
		if(arg != null) {
			for(String type: arg) {
				values.add((new org.hl7.fhir.r4.model.Timing.EventTimingEnumFactory()).fromType(new org.hl7.fhir.r4.model.CodeType(type)));
			}
		}
	...
	this.adaptee.addWhen(org.hl7.fhir.r4.model.Timing.EventTiming.fromCode(arg));
	}
