...
public class DeviceUdiCarrierWrapper implements DeviceUdiCarrier {
	...
	private org.hl7.fhir.r4.model.Device.DeviceUdiCarrierComponent adaptee;

	public DeviceUdiCarrierWrapper() {
	
	}

	public DeviceUdiCarrierWrapper(org.hl7.fhir.r4.model.Device.DeviceUdiCarrierComponent adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Device.DeviceUdiCarrierComponent getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Device.DeviceUdiCarrierComponent arg) {
		this.adaptee=arg;
	}
	...
	public void setEntryType(String arg) {
		if (arg != null) {
			this.adaptee.setEntryType(org.hl7.fhir.r4.model.Device.UDIEntryType.fromCode(arg));
		}
	}
