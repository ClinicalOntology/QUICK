...
public class IdentifierWrapper implements Identifier {
	...
	private org.hl7.fhir.r4.model.Identifier adaptee;

	public IdentifierWrapper() {
	
	}

	public IdentifierWrapper(org.hl7.fhir.r4.model.Identifier adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Identifier getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Identifier arg) {
		this.adaptee=arg;
	}
	...
	public void setUse(String arg) {
		if (arg != null) {
			this.adaptee.setUse(org.hl7.fhir.r4.model.Identifier.IdentifierUse.fromCode(arg));
		}
	}
	...
	public Organization getAssigner() {
		return new org.reimagineehr.model.quick.r4.wrapper.party.OrganizationWrapper((org.hl7.fhir.r4.model.Organization)((org.hl7.fhir.r4.model.Reference)this.adaptee.getAssigner()).getResource());
	}

	public void setAssigner(Organization arg) {
		this.adaptee.setAssigner(new org.hl7.fhir.r4.model.Reference(((org.reimagineehr.model.quick.r4.wrapper.party.OrganizationWrapper)arg).getAdaptee()));
	}
