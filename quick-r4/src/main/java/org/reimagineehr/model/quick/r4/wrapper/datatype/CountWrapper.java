...
public class CountWrapper implements Count {
	...
	private org.hl7.fhir.r4.model.Count adaptee;

	public CountWrapper() {
	
	}

	public CountWrapper(org.hl7.fhir.r4.model.Count adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Count getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Count arg) {
		this.adaptee=arg;
	}
