...
public class EncounterWrapper implements Encounter {
	...
	private org.hl7.fhir.r4.model.Encounter adaptee;

	public EncounterWrapper() {
	
	}

	public EncounterWrapper(org.hl7.fhir.r4.model.Encounter adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Encounter getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Encounter arg) {
		this.adaptee=arg;
	}
	...
	public void setStatus(String arg) {
		if (arg != null) {
			this.adaptee.setStatus(org.hl7.fhir.r4.model.Encounter.EncounterStatus.fromCode(arg));
		}
	}
	...
	public List<Participation> getPerformer() {
		...
		java.util.List<org.hl7.fhir.r4.model.Encounter.EncounterParticipantComponent> itemList = this.adaptee.getParticipant();
		for(org.hl7.fhir.r4.model.Encounter.EncounterParticipantComponent item : itemList) {
			returnList.add(new org.reimagineehr.model.quick.r4.wrapper.backbone.EncounterParticipantWrapper(item));	}
		return returnList;
	}

	public void setPerformer(java.util.List<Participation> arg) {
		java.util.List<org.hl7.fhir.r4.model.Encounter.EncounterParticipantComponent> itemList = new java.util.ArrayList<>();
		for(Participation item : arg) {
			itemList.add(((org.reimagineehr.model.quick.r4.wrapper.backbone.EncounterParticipantWrapper)item).getAdaptee());
		}
		this.adaptee.setParticipant(itemList);
	}

	public void addPerformer(Participation arg) {
	this.adaptee.getParticipant().add(((org.reimagineehr.model.quick.r4.wrapper.backbone.EncounterParticipantWrapper)arg).getAdaptee());
	}
	...
	public Coding getEncounterClass() {
		return org.reimagineehr.model.quick.r4.utils.R4Utils.getAsQuickCoding(this.adaptee.getClass_());
	}

	public void setEncounterClass(Coding arg) {
		this.adaptee.setClass_(org.reimagineehr.model.quick.r4.utils.R4Utils.getAsFhirCoding(arg));
	}

	public List<CodeableConcept> getType() {
		return org.reimagineehr.model.quick.r4.utils.R4Utils.getAsQuickCodeableConcept(this.adaptee.getType());
	}
	...
	public void addType(CodeableConcept arg) {
		this.adaptee.addType(org.reimagineehr.model.quick.r4.utils.R4Utils.getAsFhirCodeableConcept(arg));
	}
	...
	return new org.reimagineehr.model.quick.r4.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getPriority());
	}

	public void setPriority(CodeableConcept arg) {
	this.adaptee.setPriority(org.reimagineehr.model.quick.r4.utils.R4Utils.getAsFhirCodeableConcept(arg));
	}
	...
	public Duration getLength() {
		...
		return new org.reimagineehr.model.quick.r4.wrapper.datatype.DurationWrapper(this.adaptee.getLength());
	}

	public void setLength(Duration arg) {
	
		this.adaptee.setLength(((org.reimagineehr.model.quick.r4.wrapper.datatype.DurationWrapper)arg).getAdaptee());
	}
	...
	public List<EncounterDiagnosisOrProcedure> getDiagnosisOrProcedure() {
		...
		java.util.List<org.hl7.fhir.r4.model.Encounter.DiagnosisComponent> itemList = this.adaptee.getDiagnosis();
		for(org.hl7.fhir.r4.model.Encounter.DiagnosisComponent item : itemList) {
			returnList.add(new org.reimagineehr.model.quick.r4.wrapper.backbone.EncounterDiagnosisOrProcedureWrapper(item));	}
		return returnList;
	}

	public void setDiagnosisOrProcedure(java.util.List<EncounterDiagnosisOrProcedure> arg) {
		java.util.List<org.hl7.fhir.r4.model.Encounter.DiagnosisComponent> itemList = new java.util.ArrayList<>();
		for(EncounterDiagnosisOrProcedure item : arg) {
			itemList.add(((org.reimagineehr.model.quick.r4.wrapper.backbone.EncounterDiagnosisOrProcedureWrapper)item).getAdaptee());
		}
		this.adaptee.setDiagnosis(itemList);
	}

	public void addDiagnosisOrProcedure(EncounterDiagnosisOrProcedure arg) {
	this.adaptee.getDiagnosis().add(((org.reimagineehr.model.quick.r4.wrapper.backbone.EncounterDiagnosisOrProcedureWrapper)arg).getAdaptee());
	}

	public Hospitalization getHospitalization() {
	
		return new org.reimagineehr.model.quick.r4.wrapper.backbone.HospitalizationWrapper(this.adaptee.getHospitalization());
	}

	public void setHospitalization(Hospitalization arg) {
	
		this.adaptee.setHospitalization(((org.reimagineehr.model.quick.r4.wrapper.backbone.HospitalizationWrapper)arg).getAdaptee());
	}
	...
	public Organization getServiceProvider() {
		return new org.reimagineehr.model.quick.r4.wrapper.party.OrganizationWrapper((org.hl7.fhir.r4.model.Organization)((org.hl7.fhir.r4.model.Reference)this.adaptee.getServiceProvider()).getResource());
	}

	public void setServiceProvider(Organization arg) {
		this.adaptee.setServiceProvider(new org.hl7.fhir.r4.model.Reference(((org.reimagineehr.model.quick.r4.wrapper.party.OrganizationWrapper)arg).getAdaptee()));
	}

	public Encounter getPartOf() {
		return new org.reimagineehr.model.quick.r4.wrapper.event.EncounterWrapper((org.hl7.fhir.r4.model.Encounter)((org.hl7.fhir.r4.model.Reference)this.adaptee.getPartOf()).getResource());
	}

	public void setPartOf(Encounter arg) {
		this.adaptee.setPartOf(new org.hl7.fhir.r4.model.Reference(((org.reimagineehr.model.quick.r4.wrapper.event.EncounterWrapper)arg).getAdaptee()));
	}
