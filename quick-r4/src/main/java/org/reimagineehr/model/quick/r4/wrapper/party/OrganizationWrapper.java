...
public class OrganizationWrapper implements Organization {
	...
	private org.hl7.fhir.r4.model.Organization adaptee;

	public OrganizationWrapper() {
	
	}

	public OrganizationWrapper(org.hl7.fhir.r4.model.Organization adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Organization getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Organization arg) {
		this.adaptee=arg;
	}
	...
	public List<String> getAlias() {
		...
		if(this.adaptee.getAlias() != null) {
			for(org.hl7.fhir.r4.model.StringType type: this.adaptee.getAlias()) {
	...
	public Organization getPartOf() {
		return new org.reimagineehr.model.quick.r4.wrapper.party.OrganizationWrapper((org.hl7.fhir.r4.model.Organization)((org.hl7.fhir.r4.model.Reference)this.adaptee.getPartOf()).getResource());
	}

	public void setPartOf(Organization arg) {
		this.adaptee.setPartOf(new org.hl7.fhir.r4.model.Reference(((org.reimagineehr.model.quick.r4.wrapper.party.OrganizationWrapper)arg).getAdaptee()));
	}
	...
	public List<OrganizationalContact> getContact() {
		...
		List<org.hl7.fhir.r4.model.Organization.OrganizationContactComponent> items = this.adaptee.getContact();
		for(org.hl7.fhir.r4.model.Organization.OrganizationContactComponent item : items) {
			returnList.add(new org.reimagineehr.model.quick.r4.wrapper.backbone.OrganizationalContactWrapper(item));
		}
		return returnList;
	}

	public void setContact(java.util.List<OrganizationalContact> arg) {
		List<org.hl7.fhir.r4.model.Organization.OrganizationContactComponent> targetList = new java.util.ArrayList<>();
		for(org.reimagineehr.model.quick.api.backbone.OrganizationalContact item : arg) {
			targetList.add(((org.reimagineehr.model.quick.r4.wrapper.backbone.OrganizationalContactWrapper)item).getAdaptee());
		}
		this.adaptee.setContact(targetList);
	}

	public void addContact(OrganizationalContact arg) {
		this.adaptee.addContact(((org.reimagineehr.model.quick.r4.wrapper.backbone.OrganizationalContactWrapper)arg).getAdaptee());
	}
