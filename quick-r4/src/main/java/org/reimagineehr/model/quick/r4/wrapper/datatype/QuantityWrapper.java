...
public class QuantityWrapper implements Quantity {
	...
	private org.hl7.fhir.r4.model.Quantity adaptee;

	public QuantityWrapper() {
	
	}

	public QuantityWrapper(org.hl7.fhir.r4.model.Quantity adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Quantity getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Quantity arg) {
		this.adaptee=arg;
	}
