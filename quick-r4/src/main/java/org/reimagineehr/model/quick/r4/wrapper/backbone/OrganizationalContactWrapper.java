...
public class OrganizationalContactWrapper implements OrganizationalContact {
	...
	private org.hl7.fhir.r4.model.Organization.OrganizationContactComponent adaptee;

	public OrganizationalContactWrapper() {
	
	}

	public OrganizationalContactWrapper(org.hl7.fhir.r4.model.Organization.OrganizationContactComponent adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Organization.OrganizationContactComponent getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Organization.OrganizationContactComponent arg) {
		this.adaptee=arg;
	}
	...
	return new org.reimagineehr.model.quick.r4.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getPurpose());
	}

	public void setPurpose(CodeableConcept arg) {
	this.adaptee.setPurpose(org.reimagineehr.model.quick.r4.utils.R4Utils.getAsFhirCodeableConcept(arg));
	}
