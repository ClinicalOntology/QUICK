...
public class ContactPointWrapper implements ContactPoint {
	...
	private org.hl7.fhir.r4.model.ContactPoint adaptee;

	public ContactPointWrapper() {
	
	}

	public ContactPointWrapper(org.hl7.fhir.r4.model.ContactPoint adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.ContactPoint getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.ContactPoint arg) {
		this.adaptee=arg;
	}
	...
	public void setSystem(String arg) {
		if (arg != null) {
			this.adaptee.setSystem(org.hl7.fhir.r4.model.ContactPoint.ContactPointSystem.fromCode(arg));
		}
	}
	...
	public void setUse(String arg) {
		if (arg != null) {
			this.adaptee.setUse(org.hl7.fhir.r4.model.ContactPoint.ContactPointUse.fromCode(arg));
		}
	}
