...
public class MedicationAdministrationWrapper implements MedicationAdministration {
	...
	private org.hl7.fhir.r4.model.MedicationAdministration adaptee;

	public MedicationAdministrationWrapper() {
	
	}

	public MedicationAdministrationWrapper(org.hl7.fhir.r4.model.MedicationAdministration adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.MedicationAdministration getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.MedicationAdministration arg) {
		this.adaptee=arg;
	}
	...
	public void setStatus(String arg) {
		if (arg != null) {
			this.adaptee.setStatus(org.hl7.fhir.r4.model.MedicationAdministration.MedicationAdministrationStatus.fromCode(arg));
		}
	}

	public CodeableConcept getStatusReason() {
		java.util.List<org.hl7.fhir.r4.model.Extension> extensions = this.adaptee.getExtensionsByUrl("http://example.com/extensions/my-status-reason");
	...
	public List<Participation> getPerformer() {
		...
		java.util.List<org.hl7.fhir.r4.model.MedicationAdministration.MedicationAdministrationPerformerComponent> itemList = this.adaptee.getPerformer();
		for(org.hl7.fhir.r4.model.MedicationAdministration.MedicationAdministrationPerformerComponent item : itemList) {
			returnList.add(new org.reimagineehr.model.quick.r4.wrapper.backbone.MedicationAdministrationPerformerWrapper(item));	}
		return returnList;
	}

	public void setPerformer(java.util.List<Participation> arg) {
		java.util.List<org.hl7.fhir.r4.model.MedicationAdministration.MedicationAdministrationPerformerComponent> itemList = new java.util.ArrayList<>();
		for(Participation item : arg) {
			itemList.add(((org.reimagineehr.model.quick.r4.wrapper.backbone.MedicationAdministrationPerformerWrapper)item).getAdaptee());
		}
		this.adaptee.setPerformer(itemList);
	}

	public void addPerformer(Participation arg) {
	this.adaptee.getPerformer().add(((org.reimagineehr.model.quick.r4.wrapper.backbone.MedicationAdministrationPerformerWrapper)arg).getAdaptee());
	}
	...
	public DosageTaken getDosage() {
		...
		return new org.reimagineehr.model.quick.r4.wrapper.backbone.DosageTakenWrapper(this.adaptee.getDosage());
	}

	public void setDosage(DosageTaken arg) {
	
		this.adaptee.setDosage(((org.reimagineehr.model.quick.r4.wrapper.backbone.DosageTakenWrapper)arg).getAdaptee());
	}
