...
public class GroupCharacteristicWrapper implements GroupCharacteristic {
	...
	private org.hl7.fhir.r4.model.Group.GroupCharacteristicComponent adaptee;

	public GroupCharacteristicWrapper() {
	
	}

	public GroupCharacteristicWrapper(org.hl7.fhir.r4.model.Group.GroupCharacteristicComponent adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Group.GroupCharacteristicComponent getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Group.GroupCharacteristicComponent arg) {
		this.adaptee=arg;
	}
	...
	public ObservationValueChoice getValue() {
		...
		} else if(type instanceof org.hl7.fhir.r4.model.Quantity) {
