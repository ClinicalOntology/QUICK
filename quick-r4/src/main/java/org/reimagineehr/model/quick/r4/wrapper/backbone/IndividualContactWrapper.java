...
public class IndividualContactWrapper implements IndividualContact {
	...
	private org.hl7.fhir.r4.model.Patient.ContactComponent adaptee;

	public IndividualContactWrapper() {
	
	}

	public IndividualContactWrapper(org.hl7.fhir.r4.model.Patient.ContactComponent adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Patient.ContactComponent getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Patient.ContactComponent arg) {
		this.adaptee=arg;
	}

	public HumanName getName() {
	
		return new org.reimagineehr.model.quick.r4.wrapper.backbone.HumanNameWrapper(this.adaptee.getName());
	}

	public void setName(HumanName arg) {
	
		this.adaptee.setName(((org.reimagineehr.model.quick.r4.wrapper.backbone.HumanNameWrapper)arg).getAdaptee());
	}
	...
	public Address getAddress() {
		...
		return new org.reimagineehr.model.quick.r4.wrapper.backbone.AddressWrapper(this.adaptee.getAddress());
	}

	public void setAddress(Address arg) {
	
		this.adaptee.setAddress(((org.reimagineehr.model.quick.r4.wrapper.backbone.AddressWrapper)arg).getAdaptee());
	}

	public List<CodeableConcept> getRelationship() {
		return org.reimagineehr.model.quick.r4.utils.R4Utils.getAsQuickCodeableConcept(this.adaptee.getRelationship());
	}

	public void setRelationship(java.util.List<CodeableConcept> arg) {
		this.adaptee.setRelationship(org.reimagineehr.model.quick.r4.utils.R4Utils.getAsFhirCodeableConcept(arg));
	}

	public void addRelationship(CodeableConcept arg) {
		this.adaptee.addRelationship(org.reimagineehr.model.quick.r4.utils.R4Utils.getAsFhirCodeableConcept(arg));
	}
