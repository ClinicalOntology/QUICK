...
public class SpecimenWrapper implements Specimen {
	...
	private org.hl7.fhir.r4.model.Specimen adaptee;

	public SpecimenWrapper() {
	
	}

	public SpecimenWrapper(org.hl7.fhir.r4.model.Specimen adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Specimen getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Specimen arg) {
		this.adaptee=arg;
	}
