...
public class GroupWrapper implements Group {
	...
	private org.hl7.fhir.r4.model.Group adaptee;

	public GroupWrapper() {
	
	}

	public GroupWrapper(org.hl7.fhir.r4.model.Group adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Group getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Group arg) {
		this.adaptee=arg;
	}
	...
	public String getType() {
		org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.Group.GroupType>  item = this.adaptee.getTypeElement();
		return item.getValueAsString();
	}

	public void setType(String arg) {
		this.adaptee.setTypeElement((new org.hl7.fhir.r4.model.Group.GroupTypeEnumFactory()).fromType(new org.hl7.fhir.r4.model.CodeType(arg)));
	}
	...
	public List<GroupCharacteristic> getCharacteristic() {
		...
		List<org.hl7.fhir.r4.model.Group.GroupCharacteristicComponent> items = this.adaptee.getCharacteristic();
		for(org.hl7.fhir.r4.model.Group.GroupCharacteristicComponent item : items) {
			returnList.add(new org.reimagineehr.model.quick.r4.wrapper.backbone.GroupCharacteristicWrapper(item));
		}
		return returnList;
	}

	public void setCharacteristic(java.util.List<GroupCharacteristic> arg) {
		List<org.hl7.fhir.r4.model.Group.GroupCharacteristicComponent> targetList = new java.util.ArrayList<>();
		for(org.reimagineehr.model.quick.api.backbone.GroupCharacteristic item : arg) {
			targetList.add(((org.reimagineehr.model.quick.r4.wrapper.backbone.GroupCharacteristicWrapper)item).getAdaptee());
		}
		this.adaptee.setCharacteristic(targetList);
	}

	public void addCharacteristic(GroupCharacteristic arg) {
		this.adaptee.addCharacteristic(((org.reimagineehr.model.quick.r4.wrapper.backbone.GroupCharacteristicWrapper)arg).getAdaptee());
	}
	...
	public List<GroupMember> getMember() {
		...
		List<org.hl7.fhir.r4.model.Group.GroupMemberComponent> items = this.adaptee.getMember();
		for(org.hl7.fhir.r4.model.Group.GroupMemberComponent item : items) {
			returnList.add(new org.reimagineehr.model.quick.r4.wrapper.backbone.GroupMemberWrapper(item));
		}
		return returnList;
	}

	public void setMember(java.util.List<GroupMember> arg) {
		List<org.hl7.fhir.r4.model.Group.GroupMemberComponent> targetList = new java.util.ArrayList<>();
		for(org.reimagineehr.model.quick.api.backbone.GroupMember item : arg) {
			targetList.add(((org.reimagineehr.model.quick.r4.wrapper.backbone.GroupMemberWrapper)item).getAdaptee());
		}
		this.adaptee.setMember(targetList);
	}

	public void addMember(GroupMember arg) {
		this.adaptee.addMember(((org.reimagineehr.model.quick.r4.wrapper.backbone.GroupMemberWrapper)arg).getAdaptee());
	}
