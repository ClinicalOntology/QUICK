...
public class TimingWrapper implements Timing {
	...
	private org.hl7.fhir.r4.model.Timing adaptee;

	public TimingWrapper() {
	
	}

	public TimingWrapper(org.hl7.fhir.r4.model.Timing adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Timing getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Timing arg) {
		this.adaptee=arg;
	}
	...
	public List<Date> getEvent() {
		...
		if(this.adaptee.getEvent() != null) {
			for(org.hl7.fhir.r4.model.DateTimeType type: this.adaptee.getEvent()) {
	...
	public void setEvent(java.util.List<Date> arg) {
		...
		java.util.List<org.hl7.fhir.r4.model.DateTimeType> values = new java.util.ArrayList<>();
		if(arg != null) {
			for(Date type: arg) {
				values.add(new org.hl7.fhir.r4.model.DateTimeType(type));
			}
		}
	...
	public TimingRepeat getRepeat() {
		...
		return new org.reimagineehr.model.quick.r4.wrapper.backbone.TimingRepeatWrapper(this.adaptee.getRepeat());
	}

	public void setRepeat(TimingRepeat arg) {
	
		this.adaptee.setRepeat(((org.reimagineehr.model.quick.r4.wrapper.backbone.TimingRepeatWrapper)arg).getAdaptee());
	}
