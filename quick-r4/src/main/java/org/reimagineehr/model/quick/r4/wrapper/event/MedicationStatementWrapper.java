...
public class MedicationStatementWrapper implements MedicationStatement {
	...
	private org.hl7.fhir.r4.model.MedicationStatement adaptee;

	public MedicationStatementWrapper() {
	
	}

	public MedicationStatementWrapper(org.hl7.fhir.r4.model.MedicationStatement adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.MedicationStatement getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.MedicationStatement arg) {
		this.adaptee=arg;
	}
	...
	public void setStatus(String arg) {
		if (arg != null) {
			this.adaptee.setStatus(org.hl7.fhir.r4.model.MedicationStatement.MedicationStatementStatus.fromCode(arg));
		}
	}
	...
	public List<Request> getBasedOn() {
		...
		for(org.hl7.fhir.r4.model.Reference reference : references) {
			...
			if(resource == null) {
				...
				else if(resource instanceof org.hl7.fhir.r4.model.CarePlan) {
	...
	for(Request item : arg) {
		...
		} else if(item instanceof org.hl7.fhir.r4.model.CarePlan) {
	...
	public void addBasedOn(Request arg) {
		...
		if(arg instanceof org.hl7.fhir.r4.model.MedicationRequest) {
			...
			this.adaptee.addBasedOn(reference);
		} else if(arg instanceof org.hl7.fhir.r4.model.CarePlan) {
	...
	public List<DosageInstruction> getDosage() {
		...
		List<org.hl7.fhir.r4.model.Dosage> items = this.adaptee.getDosage();
	...
	public void addDosage(DosageInstruction arg) {
		this.adaptee.addDosage(((org.reimagineehr.model.quick.r4.wrapper.backbone.DosageInstructionWrapper)arg).getAdaptee());
	}

	public Medication getMedication() {
		return new org.reimagineehr.model.quick.r4.wrapper.other.MedicationWrapper((org.hl7.fhir.r4.model.Medication)((org.hl7.fhir.r4.model.Reference)this.adaptee.getMedication()).getResource());
	}

	public void setMedication(Medication arg) {
		this.adaptee.setMedication(new org.hl7.fhir.r4.model.Reference(((org.reimagineehr.model.quick.r4.wrapper.other.MedicationWrapper)arg).getAdaptee()));
	}

	public Party getInformationSource() {
		Party returnValue = null;
		org.hl7.fhir.r4.model.Reference reference = this.adaptee.getInformationSource();
		org.hl7.fhir.r4.model.Resource resource = (org.hl7.fhir.r4.model.Resource)reference.getResource();
		if(resource instanceof org.hl7.fhir.r4.model.Patient) { returnValue = new org.reimagineehr.model.quick.r4.wrapper.party.PatientWrapper((org.hl7.fhir.r4.model.Patient)resource);}
	...
	public void setInformationSource(Party arg) {
		org.hl7.fhir.r4.model.Resource resource = ((org.reimagineehr.model.quick.r4.wrapper.api.Wrapper)arg).getAdaptee();
		org.hl7.fhir.r4.model.Reference reference = null;
		if(resource instanceof org.hl7.fhir.r4.model.Patient||resource instanceof org.hl7.fhir.r4.model.Practitioner||resource instanceof org.hl7.fhir.r4.model.RelatedPerson||resource instanceof org.hl7.fhir.r4.model.Organization) {
		reference = new org.hl7.fhir.r4.model.Reference();
		} else {
