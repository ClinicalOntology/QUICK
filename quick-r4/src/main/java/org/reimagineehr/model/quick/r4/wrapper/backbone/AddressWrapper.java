...
public class AddressWrapper implements Address {
	...
	private org.hl7.fhir.r4.model.Address adaptee;

	public AddressWrapper() {
	
	}

	public AddressWrapper(org.hl7.fhir.r4.model.Address adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Address getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Address arg) {
		this.adaptee=arg;
	}
	...
	public void setUse(String arg) {
		if (arg != null) {
			this.adaptee.setUse(org.hl7.fhir.r4.model.Address.AddressUse.fromCode(arg));
		}
	}
	...
	public void setType(String arg) {
		if (arg != null) {
			this.adaptee.setType(org.hl7.fhir.r4.model.Address.AddressType.fromCode(arg));
		}
	}
	...
	public List<String> getLine() {
		...
		if(this.adaptee.getLine() != null) {
			for(org.hl7.fhir.r4.model.StringType type: this.adaptee.getLine()) {
