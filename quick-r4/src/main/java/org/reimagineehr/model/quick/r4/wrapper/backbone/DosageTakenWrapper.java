...
public class DosageTakenWrapper implements DosageTaken {
	...
	private org.hl7.fhir.r4.model.MedicationAdministration.MedicationAdministrationDosageComponent adaptee;

	public DosageTakenWrapper() {
	
	}

	public DosageTakenWrapper(org.hl7.fhir.r4.model.MedicationAdministration.MedicationAdministrationDosageComponent adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.MedicationAdministration.MedicationAdministrationDosageComponent getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.MedicationAdministration.MedicationAdministrationDosageComponent arg) {
		this.adaptee=arg;
	}
	...
	return new org.reimagineehr.model.quick.r4.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getSite());
	}

	public void setSite(CodeableConcept arg) {
	this.adaptee.setSite(org.reimagineehr.model.quick.r4.utils.R4Utils.getAsFhirCodeableConcept(arg));
	}
	...
	public SimpleQuantity getDose() {
		return org.reimagineehr.model.quick.r4.utils.R4Utils.convertQuantityToSimpleQuantityWrapper(this.adaptee.getDose());
	}

	public void setDose(SimpleQuantity arg) {
		this.adaptee.setDose(org.reimagineehr.model.quick.r4.utils.R4Utils.convertSimpleQuantityWrapperToQuantity(arg));
	}
