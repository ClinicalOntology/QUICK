package org.reimagineehr.model.quick.r4.wrapper.event;
...
public class ProcedureWrapper implements Procedure {
	...
	private org.hl7.fhir.r4.model.Procedure adaptee;

	public ProcedureWrapper() {
	
	}

	public ProcedureWrapper(org.hl7.fhir.r4.model.Procedure adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Procedure getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Procedure arg) {
		this.adaptee=arg;
	}
	...
	public void setStatus(String arg) {
		if (arg != null) {
			this.adaptee.setStatus(org.hl7.fhir.r4.model.Procedure.ProcedureStatus.fromCode(arg));
		}
	}
	...
	public List<Participation> getPerformer() {
		...
		java.util.List<org.hl7.fhir.r4.model.Procedure.ProcedurePerformerComponent> itemList = this.adaptee.getPerformer();
		for(org.hl7.fhir.r4.model.Procedure.ProcedurePerformerComponent item : itemList) {
			returnList.add(new org.reimagineehr.model.quick.r4.wrapper.backbone.ProcedurePerformerWrapper(item));	}
		return returnList;
	}

	public void setPerformer(java.util.List<Participation> arg) {
		java.util.List<org.hl7.fhir.r4.model.Procedure.ProcedurePerformerComponent> itemList = new java.util.ArrayList<>();
		for(Participation item : arg) {
			itemList.add(((org.reimagineehr.model.quick.r4.wrapper.backbone.ProcedurePerformerWrapper)item).getAdaptee());
		}
		this.adaptee.setPerformer(itemList);
	}

	public void addPerformer(Participation arg) {
	this.adaptee.getPerformer().add(((org.reimagineehr.model.quick.r4.wrapper.backbone.ProcedurePerformerWrapper)arg).getAdaptee());
	}

	public List<CodeableConcept> getReasonCode() {
		return org.reimagineehr.model.quick.r4.utils.R4Utils.getAsQuickCodeableConcept(this.adaptee.getReasonCode());
	}

	public void setReasonCode(java.util.List<CodeableConcept> arg) {
		this.adaptee.setReasonCode(org.reimagineehr.model.quick.r4.utils.R4Utils.getAsFhirCodeableConcept(arg));
	}

	public void addReasonCode(CodeableConcept arg) {
		this.adaptee.addReasonCode(org.reimagineehr.model.quick.r4.utils.R4Utils.getAsFhirCodeableConcept(arg));
	}

	public List<Finding> getReasonReference() {
		java.util.List<Finding> returnValue = new java.util.ArrayList<>();
		java.util.List<org.hl7.fhir.r4.model.Reference> references = this.adaptee.getReasonReference();
		for(org.hl7.fhir.r4.model.Reference reference : references) {
			...
			if(resource == null) {
				...
				if(resource instanceof org.hl7.fhir.r4.model.Condition) {
					returnValue.add(new org.reimagineehr.model.quick.r4.wrapper.finding.ConditionWrapper((org.hl7.fhir.r4.model.Condition) resource));
				}
				else if(resource instanceof org.hl7.fhir.r4.model.Observation) {
					returnValue.add(new org.reimagineehr.model.quick.r4.wrapper.finding.ObservationWrapper((org.hl7.fhir.r4.model.Observation) resource));
				}
			}
			return returnValue;
	}
	...
	for(Finding item : arg) {
		...
		if(item instanceof org.hl7.fhir.r4.model.Condition) {
			reference.setResource(((org.reimagineehr.model.quick.r4.wrapper.finding.ConditionWrapper)item).getAdaptee());
			this.adaptee.addReasonReference(reference);
		} else if(item instanceof org.hl7.fhir.r4.model.Observation) {
			reference.setResource(((org.reimagineehr.model.quick.r4.wrapper.finding.ObservationWrapper)item).getAdaptee());
			this.adaptee.addReasonReference(reference);
		}
	}
	}
	...
	public void addReasonReference(Finding arg) {
		...
		org.hl7.fhir.r4.model.Reference reference = new org.hl7.fhir.r4.model.Reference();
		if(arg instanceof org.hl7.fhir.r4.model.Condition) {
			reference.setResource(((org.reimagineehr.model.quick.r4.wrapper.finding.ConditionWrapper)arg).getAdaptee());
			this.adaptee.addReasonReference(reference);
		} else if(arg instanceof org.hl7.fhir.r4.model.Observation) {
			reference.setResource(((org.reimagineehr.model.quick.r4.wrapper.finding.ObservationWrapper)arg).getAdaptee());
			this.adaptee.addReasonReference(reference);
		}
	}
	...
	public OccurrenceAllChoice getOccurrence() {
		...
		Object choice = null;
		org.hl7.fhir.r4.model.Type type = this.adaptee.getPerformed();
	...
	public void setOccurrence(OccurrenceAllChoice arg) {
		...
		if(choice.getDateTime() != null) {
			this.adaptee.setPerformed(new org.hl7.fhir.r4.model.DateTimeType(choice.getDateTime()));
		}else if(choice.getPeriod() != null) {
			this.adaptee.setPerformed(((org.reimagineehr.model.quick.r4.wrapper.datatype.PeriodWrapper)choice.getPeriod()).getAdaptee());
		}else if(choice.getString() != null) {
			this.adaptee.setPerformed(new org.hl7.fhir.r4.model.StringType(choice.getString()));
		}else if(choice.getAge() != null) {
			this.adaptee.setPerformed(((org.reimagineehr.model.quick.r4.wrapper.datatype.AgeWrapper)choice.getAge()).getAdaptee());
		}else if(choice.getRange() != null) {
			this.adaptee.setPerformed(((org.reimagineehr.model.quick.r4.wrapper.datatype.RangeWrapper)choice.getRange()).getAdaptee());
		}
	}
		...
		for(org.hl7.fhir.r4.model.Reference reference : references) {
			...
			if(resource == null) {
				...
				if(resource instanceof org.hl7.fhir.r4.model.CarePlan) {
					returnValue.add(new org.reimagineehr.model.quick.r4.wrapper.request.CarePlanWrapper((org.hl7.fhir.r4.model.CarePlan) resource));
				}
	...
	for(Request item : arg) {
		org.hl7.fhir.r4.model.Reference reference = new org.hl7.fhir.r4.model.Reference();
		if(item instanceof org.hl7.fhir.r4.model.CarePlan) {
			reference.setResource(((org.reimagineehr.model.quick.r4.wrapper.request.CarePlanWrapper)item).getAdaptee());
	...
	public void addBasedOn(Request arg) {
		...
		org.hl7.fhir.r4.model.Reference reference = new org.hl7.fhir.r4.model.Reference();
		if(arg instanceof org.hl7.fhir.r4.model.CarePlan) {
			reference.setResource(((org.reimagineehr.model.quick.r4.wrapper.request.CarePlanWrapper)arg).getAdaptee());
			this.adaptee.addBasedOn(reference);
	...
	public Date getRecorded() {
		java.util.List<org.hl7.fhir.r4.model.Extension> extensions = this.adaptee.getExtensionsByUrl("http://example.com/extensions/my-recorded");
		if(extensions != null && extensions.size() > 0) {
			org.hl7.fhir.r4.model.Extension extension = extensions.get(0);
			return ((org.hl7.fhir.r4.model.DateType)extension.getValue()).getValue();
		} else {
			return null;
		}
	}
	...
	public void setRecorded(Date arg) {
		...
		extension.setValue(new org.hl7.fhir.r4.model.DateType(arg));
	}
	...
	return new org.reimagineehr.model.quick.r4.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getOutcome());
	}

	public void setOutcome(CodeableConcept arg) {
	this.adaptee.setOutcome(org.reimagineehr.model.quick.r4.utils.R4Utils.getAsFhirCodeableConcept(arg));
	}
	...
	public List<Event> getPartOf() {
		...
		java.util.List<org.hl7.fhir.r4.model.Reference> references = this.adaptee.getPartOf();
		for(org.hl7.fhir.r4.model.Reference reference : references) {
			org.hl7.fhir.r4.model.Resource resource = (org.hl7.fhir.r4.model.Resource)reference.getResource();
			if(resource == null) {
				throw new RuntimeException("Reference cannot have a null resource. Please first fetch resource");
				...
				if(resource instanceof org.hl7.fhir.r4.model.Procedure) {
					returnValue.add(new org.reimagineehr.model.quick.r4.wrapper.event.ProcedureWrapper((org.hl7.fhir.r4.model.Procedure) resource));
				}
				else if(resource instanceof org.hl7.fhir.r4.model.MedicationAdministration) {
					returnValue.add(new org.reimagineehr.model.quick.r4.wrapper.event.MedicationAdministrationWrapper((org.hl7.fhir.r4.model.MedicationAdministration) resource));
				}
				else if(resource instanceof org.hl7.fhir.r4.model.Observation) {
					returnValue.add(new org.reimagineehr.model.quick.r4.wrapper.finding.ObservationWrapper((org.hl7.fhir.r4.model.Observation) resource));
				}
	...
	for(Event item : arg) {
		org.hl7.fhir.r4.model.Reference reference = new org.hl7.fhir.r4.model.Reference();
		if(item instanceof org.hl7.fhir.r4.model.Procedure) {
			reference.setResource(((org.reimagineehr.model.quick.r4.wrapper.event.ProcedureWrapper)item).getAdaptee());
			this.adaptee.addPartOf(reference);
		} else if(item instanceof org.hl7.fhir.r4.model.MedicationAdministration) {
			reference.setResource(((org.reimagineehr.model.quick.r4.wrapper.event.MedicationAdministrationWrapper)item).getAdaptee());
			this.adaptee.addPartOf(reference);
		} else if(item instanceof org.hl7.fhir.r4.model.Observation) {
			reference.setResource(((org.reimagineehr.model.quick.r4.wrapper.finding.ObservationWrapper)item).getAdaptee());
			this.adaptee.addPartOf(reference);
	...
	public void addPartOf(Event arg) {
		...
		org.hl7.fhir.r4.model.Reference reference = new org.hl7.fhir.r4.model.Reference();
		if(arg instanceof org.hl7.fhir.r4.model.Procedure) {
			reference.setResource(((org.reimagineehr.model.quick.r4.wrapper.event.ProcedureWrapper)arg).getAdaptee());
			this.adaptee.addPartOf(reference);
		} else if(arg instanceof org.hl7.fhir.r4.model.MedicationAdministration) {
			reference.setResource(((org.reimagineehr.model.quick.r4.wrapper.event.MedicationAdministrationWrapper)arg).getAdaptee());
			this.adaptee.addPartOf(reference);
		} else if(arg instanceof org.hl7.fhir.r4.model.Observation) {
			reference.setResource(((org.reimagineehr.model.quick.r4.wrapper.finding.ObservationWrapper)arg).getAdaptee());
			this.adaptee.addPartOf(reference);
