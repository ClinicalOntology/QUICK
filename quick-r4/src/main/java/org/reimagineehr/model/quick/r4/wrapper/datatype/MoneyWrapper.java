...
public class MoneyWrapper implements Money {
	...
	private org.hl7.fhir.r4.model.MoneyQuantity adaptee;

	public MoneyWrapper() {
	
	}

	public MoneyWrapper(org.hl7.fhir.r4.model.MoneyQuantity adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.MoneyQuantity getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.MoneyQuantity arg) {
		this.adaptee=arg;
	}
