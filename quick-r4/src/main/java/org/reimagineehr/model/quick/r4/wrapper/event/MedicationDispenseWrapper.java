...
public class MedicationDispenseWrapper implements MedicationDispense {
	...
	private org.hl7.fhir.r4.model.MedicationDispense adaptee;

	public MedicationDispenseWrapper() {
	
	}

	public MedicationDispenseWrapper(org.hl7.fhir.r4.model.MedicationDispense adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.MedicationDispense getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.MedicationDispense arg) {
		this.adaptee=arg;
	}
	...
	public void setStatus(String arg) {
		if (arg != null) {
			this.adaptee.setStatus(org.hl7.fhir.r4.model.MedicationDispense.MedicationDispenseStatus.fromCode(arg));
		}
	}
	...
	public List<Participation> getPerformer() {
		...
		java.util.List<org.hl7.fhir.r4.model.MedicationDispense.MedicationDispensePerformerComponent> itemList = this.adaptee.getPerformer();
		for(org.hl7.fhir.r4.model.MedicationDispense.MedicationDispensePerformerComponent item : itemList) {
			returnList.add(new org.reimagineehr.model.quick.r4.wrapper.backbone.MedicationDispensePerformerWrapper(item));	}
		return returnList;
	}

	public void setPerformer(java.util.List<Participation> arg) {
		java.util.List<org.hl7.fhir.r4.model.MedicationDispense.MedicationDispensePerformerComponent> itemList = new java.util.ArrayList<>();
		for(Participation item : arg) {
			itemList.add(((org.reimagineehr.model.quick.r4.wrapper.backbone.MedicationDispensePerformerWrapper)item).getAdaptee());
		}
		this.adaptee.setPerformer(itemList);
	}

	public void addPerformer(Participation arg) {
	this.adaptee.getPerformer().add(((org.reimagineehr.model.quick.r4.wrapper.backbone.MedicationDispensePerformerWrapper)arg).getAdaptee());
	}
	...
	public SimpleQuantity getQuantity() {
		...
		return new org.reimagineehr.model.quick.r4.wrapper.datatype.SimpleQuantityWrapper(this.adaptee.getQuantity());
	}

	public void setQuantity(SimpleQuantity arg) {
	
		this.adaptee.setQuantity(((org.reimagineehr.model.quick.r4.wrapper.datatype.SimpleQuantityWrapper)arg).getAdaptee());
	}

	public SimpleQuantity getDaysSupply() {
	
		return new org.reimagineehr.model.quick.r4.wrapper.datatype.SimpleQuantityWrapper(this.adaptee.getDaysSupply());
	}

	public void setDaysSupply(SimpleQuantity arg) {
	
		this.adaptee.setDaysSupply(((org.reimagineehr.model.quick.r4.wrapper.datatype.SimpleQuantityWrapper)arg).getAdaptee());
	}
