...
public class RecordLinkWrapper implements RecordLink {
	...
	private org.hl7.fhir.r4.model.Patient.PatientLinkComponent adaptee;

	public RecordLinkWrapper() {
	
	}

	public RecordLinkWrapper(org.hl7.fhir.r4.model.Patient.PatientLinkComponent adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.Patient.PatientLinkComponent getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.Patient.PatientLinkComponent arg) {
		this.adaptee=arg;
	}

	public IndividualCareRecipient getOther() {
		IndividualCareRecipient returnValue = null;
		org.hl7.fhir.r4.model.Reference reference = this.adaptee.getOther();
	...
	public void setOther(IndividualCareRecipient arg) {
		...
		if(resource instanceof org.hl7.fhir.r4.model.Patient||resource instanceof org.hl7.fhir.r4.model.RelatedPerson) {
	...
	public void setType(String arg) {
		if (arg != null) {
			this.adaptee.setType(org.hl7.fhir.r4.model.Patient.LinkType.fromCode(arg));
		}
	}
