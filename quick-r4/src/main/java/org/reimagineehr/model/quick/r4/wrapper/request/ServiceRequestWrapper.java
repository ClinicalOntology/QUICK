...
public class ServiceRequestWrapper implements ServiceRequest {
	...
	private org.hl7.fhir.r4.model.ServiceRequest adaptee;

	public ServiceRequestWrapper() {
	
	}

	public ServiceRequestWrapper(org.hl7.fhir.r4.model.ServiceRequest adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.r4.model.ServiceRequest getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.r4.model.ServiceRequest arg) {
		this.adaptee=arg;
	}
	...
	public void setIntent(String arg) {
		if (arg != null) {
			this.adaptee.setIntent(org.hl7.fhir.r4.model.ServiceRequest.ServiceRequestIntent.fromCode(arg));
		}
	}
	...
	public Party getRequester() {
		Party retVal = null;
		org.hl7.fhir.r4.model.ServiceRequest.ServiceRequestRequesterComponent hapiType = this.adaptee.getRequester();
		...
		if(agentResource != null) {
			...
			} else if (agentResource instanceof org.hl7.fhir.r4.model.PractitionerRole) {
				retVal = new org.reimagineehr.model.quick.r4.wrapper.party.PractitionerRoleWrapper((org.hl7.fhir.r4.model.PractitionerRole) agentResource);
	...
	public void setRequester(Party arg) {
		org.hl7.fhir.r4.model.ServiceRequest.ServiceRequestRequesterComponent hapiType = new org.hl7.fhir.r4.model.ServiceRequest.ServiceRequestRequesterComponent();
		if(arg != null) {
			...
			} else if (arg instanceof org.reimagineehr.model.quick.r4.wrapper.party.PractitionerRoleWrapper) {
				reference.setResource(((org.reimagineehr.model.quick.r4.wrapper.party.PractitionerRoleWrapper)arg).getAdaptee());
				hapiType.setAgent(reference);
	...
	public void setStatus(String arg) {
		if (arg != null) {
			this.adaptee.setStatus(org.hl7.fhir.r4.model.ServiceRequest.ServiceRequestStatus.fromCode(arg));
		}
	}
