...
public class MedicationWrapper implements Medication {
	...
	public Organization getManufacturer() {
		return new org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper((org.hl7.fhir.dstu3.model.Organization)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getManufacturer()).getResource());
	}

	public void setManufacturer(Organization arg) {
		this.adaptee.setManufacturer(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper)arg).getAdaptee()));
	}

	public CodeableConcept getForm() {
	return new org.reimagineehr.model.quick.stu3.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getForm());
	}
	...
	public List<Ingredient> getIngredient() {
		...
		for(org.hl7.fhir.dstu3.model.Medication.MedicationIngredientComponent item : items) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.IngredientWrapper(item));
		}
		return returnList;
	}
	...
	public void setIngredient(java.util.List<Ingredient> arg) {
		...
		for(org.reimagineehr.model.quick.api.backbone.Ingredient item : arg) {
			targetList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.IngredientWrapper)item).getAdaptee());
		}
		this.adaptee.setIngredient(targetList);
	}

	public void addIngredient(Ingredient arg) {
		this.adaptee.addIngredient(((org.reimagineehr.model.quick.stu3.wrapper.backbone.IngredientWrapper)arg).getAdaptee());
	}
