 ...
 * License: Apache 2
*/
public class DurationWrapper implements Duration {

	private org.hl7.fhir.dstu3.model.Duration adaptee;

	public DurationWrapper() {
	
	}

	public DurationWrapper(org.hl7.fhir.dstu3.model.Duration adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.dstu3.model.Duration getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.dstu3.model.Duration arg) {
		this.adaptee=arg;
	}
