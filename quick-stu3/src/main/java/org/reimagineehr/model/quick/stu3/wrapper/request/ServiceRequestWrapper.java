...
public class ServiceRequestWrapper implements ServiceRequest {
	...
	public Party getRequester() {
		...
		if(agentResource != null) {
			if  (agentResource instanceof org.hl7.fhir.dstu3.model.Practitioner) {
				...
				retVal = new org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerRoleWrapper((org.hl7.fhir.dstu3.model.PractitionerRole) agentResource);
	...
	public void setRequester(Party arg) {
		...
		if(arg != null) {
			...
			} else if (arg instanceof org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerRoleWrapper) {
				reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerRoleWrapper)arg).getAdaptee());
				hapiType.setAgent(reference);
