...
public class EncounterWrapper implements Encounter {
	...
	public List<Participation> getPerformer() {
		...
		for(org.hl7.fhir.dstu3.model.Encounter.EncounterParticipantComponent item : itemList) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.EncounterParticipantWrapper(item));	}
		return returnList;
	}
	...
	public void setPerformer(java.util.List<Participation> arg) {
		...
		for(Participation item : arg) {
			itemList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.EncounterParticipantWrapper)item).getAdaptee());
		}
		this.adaptee.setParticipant(itemList);
	}

	public void addPerformer(Participation arg) {
	this.adaptee.getParticipant().add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.EncounterParticipantWrapper)arg).getAdaptee());
	}
	...
	return new org.reimagineehr.model.quick.stu3.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getPriority());
	}
	...
	public Duration getLength() {
		...
		return new org.reimagineehr.model.quick.stu3.wrapper.datatype.DurationWrapper(this.adaptee.getLength());
	}

	public void setLength(Duration arg) {
	
		this.adaptee.setLength(((org.reimagineehr.model.quick.stu3.wrapper.datatype.DurationWrapper)arg).getAdaptee());
	}
	...
	public List<EncounterDiagnosisOrProcedure> getDiagnosisOrProcedure() {
		...
		for(org.hl7.fhir.dstu3.model.Encounter.DiagnosisComponent item : itemList) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.EncounterDiagnosisOrProcedureWrapper(item));	}
		return returnList;
	}
	...
	public void setDiagnosisOrProcedure(java.util.List<EncounterDiagnosisOrProcedure> arg) {
		...
		for(EncounterDiagnosisOrProcedure item : arg) {
			itemList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.EncounterDiagnosisOrProcedureWrapper)item).getAdaptee());
		}
		this.adaptee.setDiagnosis(itemList);
	}

	public void addDiagnosisOrProcedure(EncounterDiagnosisOrProcedure arg) {
	this.adaptee.getDiagnosis().add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.EncounterDiagnosisOrProcedureWrapper)arg).getAdaptee());
	}

	public Hospitalization getHospitalization() {
	
		return new org.reimagineehr.model.quick.stu3.wrapper.backbone.HospitalizationWrapper(this.adaptee.getHospitalization());
	}

	public void setHospitalization(Hospitalization arg) {
	
		this.adaptee.setHospitalization(((org.reimagineehr.model.quick.stu3.wrapper.backbone.HospitalizationWrapper)arg).getAdaptee());
	}
	...
	public Organization getServiceProvider() {
		return new org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper((org.hl7.fhir.dstu3.model.Organization)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getServiceProvider()).getResource());
	}

	public void setServiceProvider(Organization arg) {
		this.adaptee.setServiceProvider(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper)arg).getAdaptee()));
	}

	public Encounter getPartOf() {
		return new org.reimagineehr.model.quick.stu3.wrapper.event.EncounterWrapper((org.hl7.fhir.dstu3.model.Encounter)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getPartOf()).getResource());
	}

	public void setPartOf(Encounter arg) {
		this.adaptee.setPartOf(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.event.EncounterWrapper)arg).getAdaptee()));
	}
