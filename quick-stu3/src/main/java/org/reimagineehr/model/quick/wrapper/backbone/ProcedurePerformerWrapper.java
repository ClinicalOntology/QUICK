...
public class ProcedurePerformerWrapper implements Participation {
	...
	private org.hl7.fhir.dstu3.model.Procedure.ProcedurePerformerComponent adaptee;

	public ProcedurePerformerWrapper() {
	
	}

	public ProcedurePerformerWrapper(org.hl7.fhir.dstu3.model.Procedure.ProcedurePerformerComponent adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.dstu3.model.Procedure.ProcedurePerformerComponent getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.dstu3.model.Procedure.ProcedurePerformerComponent arg) {
		this.adaptee=arg;
	}
	...
	public Party getActor() {
		...
		else if(resource instanceof org.hl7.fhir.dstu3.model.PractitionerRole) { returnValue = new org.reimagineehr.model.quick.wrapper.party.PractitionerRoleWrapper((org.hl7.fhir.dstu3.model.PractitionerRole)resource);}
	...
	public Organization getOnBehalfOf() {
		return new org.reimagineehr.model.quick.wrapper.party.OrganizationWrapper((org.hl7.fhir.dstu3.model.Organization)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getOnBehalfOf()).getResource());
	}

	public void setOnBehalfOf(Organization arg) {
		this.adaptee.setOnBehalfOf(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.wrapper.party.OrganizationWrapper)arg).getAdaptee()));
	}
