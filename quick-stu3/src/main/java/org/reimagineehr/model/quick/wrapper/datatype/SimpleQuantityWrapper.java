...
public class SimpleQuantityWrapper implements SimpleQuantity {
	...
	private org.hl7.fhir.dstu3.model.SimpleQuantity adaptee;

	public SimpleQuantityWrapper() {
	
	}

	public SimpleQuantityWrapper(org.hl7.fhir.dstu3.model.SimpleQuantity adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.dstu3.model.SimpleQuantity getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.dstu3.model.SimpleQuantity arg) {
		this.adaptee=arg;
	}
