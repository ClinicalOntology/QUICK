...
public class OrganizationWrapper implements Organization {
	...
	public Organization getPartOf() {
		return new org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper((org.hl7.fhir.dstu3.model.Organization)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getPartOf()).getResource());
	}

	public void setPartOf(Organization arg) {
		this.adaptee.setPartOf(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper)arg).getAdaptee()));
	}
	...
	public List<OrganizationalContact> getContact() {
		...
		for(org.hl7.fhir.dstu3.model.Organization.OrganizationContactComponent item : items) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.OrganizationalContactWrapper(item));
		}
		return returnList;
	}
	...
	public void setContact(java.util.List<OrganizationalContact> arg) {
		...
		for(org.reimagineehr.model.quick.api.backbone.OrganizationalContact item : arg) {
			targetList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.OrganizationalContactWrapper)item).getAdaptee());
		}
		this.adaptee.setContact(targetList);
	}

	public void addContact(OrganizationalContact arg) {
		this.adaptee.addContact(((org.reimagineehr.model.quick.stu3.wrapper.backbone.OrganizationalContactWrapper)arg).getAdaptee());
	}
