...
public class PractitionerWrapper implements Practitioner {
	...
	private org.hl7.fhir.dstu3.model.Practitioner adaptee;

	public PractitionerWrapper() {
	
	}

	public PractitionerWrapper(org.hl7.fhir.dstu3.model.Practitioner adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.dstu3.model.Practitioner getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.dstu3.model.Practitioner arg) {
		this.adaptee=arg;
	}
	...
	public List<ProfessionalQualification> getQualification() {
		...
		List<org.hl7.fhir.dstu3.model.Practitioner.PractitionerQualificationComponent> items = this.adaptee.getQualification();
		for(org.hl7.fhir.dstu3.model.Practitioner.PractitionerQualificationComponent item : items) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.ProfessionalQualificationWrapper(item));
		}
		return returnList;
	}

	public void setQualification(java.util.List<ProfessionalQualification> arg) {
		List<org.hl7.fhir.dstu3.model.Practitioner.PractitionerQualificationComponent> targetList = new java.util.ArrayList<>();
		for(org.reimagineehr.model.quick.api.backbone.ProfessionalQualification item : arg) {
			targetList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.ProfessionalQualificationWrapper)item).getAdaptee());
		}
		this.adaptee.setQualification(targetList);
	}

	public void addQualification(ProfessionalQualification arg) {
		this.adaptee.addQualification(((org.reimagineehr.model.quick.stu3.wrapper.backbone.ProfessionalQualificationWrapper)arg).getAdaptee());
	}

	public List<CodeableConcept> getCommunication() {
		return org.reimagineehr.model.quick.utils.Stu3Utils.getAsQuickCodeableConcept(this.adaptee.getCommunication());
	}

	public void setCommunication(java.util.List<CodeableConcept> arg) {
		this.adaptee.setCommunication(org.reimagineehr.model.quick.utils.Stu3Utils.getAsFhirCodeableConcept(arg));
	}

	public void addCommunication(CodeableConcept arg) {
		this.adaptee.addCommunication(org.reimagineehr.model.quick.utils.Stu3Utils.getAsFhirCodeableConcept(arg));
	}
