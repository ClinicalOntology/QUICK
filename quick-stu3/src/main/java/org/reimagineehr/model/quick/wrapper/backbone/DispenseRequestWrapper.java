...
public class DispenseRequestWrapper implements DispenseRequest {
	...
	public Period getValidityPeriod() {
		...
		return new org.reimagineehr.model.quick.wrapper.datatype.PeriodWrapper(this.adaptee.getValidityPeriod());
	}

	public void setValidityPeriod(Period arg) {
	
		this.adaptee.setValidityPeriod(((org.reimagineehr.model.quick.wrapper.datatype.PeriodWrapper)arg).getAdaptee());
	}
	...
	public Duration getExpectedSupplyDuration() {
		...
		return new org.reimagineehr.model.quick.wrapper.datatype.DurationWrapper(this.adaptee.getExpectedSupplyDuration());
	}

	public void setExpectedSupplyDuration(Duration arg) {
	
		this.adaptee.setExpectedSupplyDuration(((org.reimagineehr.model.quick.wrapper.datatype.DurationWrapper)arg).getAdaptee());
	}

	public Organization getPerformer() {
		return new org.reimagineehr.model.quick.wrapper.party.OrganizationWrapper((org.hl7.fhir.dstu3.model.Organization)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getPerformer()).getResource());
	}

	public void setPerformer(Organization arg) {
		this.adaptee.setPerformer(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.wrapper.party.OrganizationWrapper)arg).getAdaptee()));
	}
