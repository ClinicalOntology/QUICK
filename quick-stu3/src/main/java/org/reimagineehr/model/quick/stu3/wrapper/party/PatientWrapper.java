package org.reimagineehr.model.quick.stu3.wrapper.party;
...
public class PatientWrapper implements Patient {
	...
	private org.hl7.fhir.dstu3.model.Patient adaptee;

	public PatientWrapper() {
	
	}

	public PatientWrapper(org.hl7.fhir.dstu3.model.Patient adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.dstu3.model.Patient getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.dstu3.model.Patient arg) {
		this.adaptee=arg;
	}
	...
	public List<HumanName> getName() {
		...
		for(org.hl7.fhir.dstu3.model.HumanName item : items) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.HumanNameWrapper(item));
		}
		return returnList;
	}
	...
	public void setName(java.util.List<HumanName> arg) {
		...
		for(org.reimagineehr.model.quick.api.backbone.HumanName item : arg) {
			targetList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.HumanNameWrapper)item).getAdaptee());
		}
		this.adaptee.setName(targetList);
	}

	public void addName(HumanName arg) {
		this.adaptee.addName(((org.reimagineehr.model.quick.stu3.wrapper.backbone.HumanNameWrapper)arg).getAdaptee());
	}
	...
	public BooleanDateTimeChoice getDeceased() {
		...
		Object choice = null;
		org.hl7.fhir.dstu3.model.Type type = this.adaptee.getDeceased();
	...
	public void setDeceased(BooleanDateTimeChoice arg) {
		...
		if(choice.getBoolean() != null) {
			this.adaptee.setDeceased(new org.hl7.fhir.dstu3.model.BooleanType(choice.getBoolean()));
		}else if(choice.getDateTime() != null) {
			this.adaptee.setDeceased(new org.hl7.fhir.dstu3.model.DateTimeType(choice.getDateTime()));
		}
	}
	...
	public List<Address> getAddress() {
		...
		for(org.hl7.fhir.dstu3.model.Address item : items) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.AddressWrapper(item));
		}
		return returnList;
	}
	...
	public void setAddress(java.util.List<Address> arg) {
		...
		for(org.reimagineehr.model.quick.api.backbone.Address item : arg) {
			targetList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.AddressWrapper)item).getAdaptee());
		}
		this.adaptee.setAddress(targetList);
	}

	public void addAddress(Address arg) {
		this.adaptee.addAddress(((org.reimagineehr.model.quick.stu3.wrapper.backbone.AddressWrapper)arg).getAdaptee());
	}

	public CodeableConcept getMaritalStatus() {
	return new org.reimagineehr.model.quick.stu3.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getMaritalStatus());
	}

	public void setMaritalStatus(CodeableConcept arg) {
	this.adaptee.setMaritalStatus(org.reimagineehr.model.quick.utils.Stu3Utils.getAsFhirCodeableConcept(arg));
	}

	public BooleanOrIntegerChoice getMultipleBirth() {
	
		Object choice = null;
		org.hl7.fhir.dstu3.model.Type type = this.adaptee.getMultipleBirth();
		if(type instanceof org.hl7.fhir.dstu3.model.BooleanType) {
			choice = ((org.hl7.fhir.dstu3.model.BooleanType)type).getValue();
		} else if(type instanceof org.hl7.fhir.dstu3.model.IntegerType) {
			choice = ((org.hl7.fhir.dstu3.model.IntegerType)type).getValue();
		}
	...
	public void setMultipleBirth(BooleanOrIntegerChoice arg) {
		...
		if(choice.getBoolean() != null) {
			this.adaptee.setMultipleBirth(new org.hl7.fhir.dstu3.model.BooleanType(choice.getBoolean()));
		}else if(choice.getInteger() != null) {
			this.adaptee.setMultipleBirth(new org.hl7.fhir.dstu3.model.IntegerType(choice.getInteger()));
		}
	}
	...
	public List<Attachment> getPhoto() {
		...
		for(org.hl7.fhir.dstu3.model.Attachment item : items) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.datatype.AttachmentWrapper(item));
		}
		return returnList;
	}
	...
	public void setPhoto(java.util.List<Attachment> arg) {
		...
		for(org.reimagineehr.model.quick.api.datatype.Attachment item : arg) {
			targetList.add(((org.reimagineehr.model.quick.stu3.wrapper.datatype.AttachmentWrapper)item).getAdaptee());
		}
		this.adaptee.setPhoto(targetList);
	}

	public void addPhoto(Attachment arg) {
		this.adaptee.addPhoto(((org.reimagineehr.model.quick.stu3.wrapper.datatype.AttachmentWrapper)arg).getAdaptee());
	}
	...
	public List<IndividualContact> getContact() {
		...
		List<org.hl7.fhir.dstu3.model.Patient.ContactComponent> items = this.adaptee.getContact();
		for(org.hl7.fhir.dstu3.model.Patient.ContactComponent item : items) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.IndividualContactWrapper(item));
		}
		return returnList;
	}

	public void setContact(java.util.List<IndividualContact> arg) {
		List<org.hl7.fhir.dstu3.model.Patient.ContactComponent> targetList = new java.util.ArrayList<>();
		for(org.reimagineehr.model.quick.api.backbone.IndividualContact item : arg) {
			targetList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.IndividualContactWrapper)item).getAdaptee());
		}
		this.adaptee.setContact(targetList);
	}

	public void addContact(IndividualContact arg) {
		this.adaptee.addContact(((org.reimagineehr.model.quick.stu3.wrapper.backbone.IndividualContactWrapper)arg).getAdaptee());
	}
	...
	public List<LanguageCompetency> getCommunication() {
		...
		List<org.hl7.fhir.dstu3.model.Patient.PatientCommunicationComponent> items = this.adaptee.getCommunication();
		for(org.hl7.fhir.dstu3.model.Patient.PatientCommunicationComponent item : items) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.LanguageCompetencyWrapper(item));
		}
		return returnList;
	}

	public void setCommunication(java.util.List<LanguageCompetency> arg) {
		List<org.hl7.fhir.dstu3.model.Patient.PatientCommunicationComponent> targetList = new java.util.ArrayList<>();
		for(org.reimagineehr.model.quick.api.backbone.LanguageCompetency item : arg) {
			targetList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.LanguageCompetencyWrapper)item).getAdaptee());
		}
		this.adaptee.setCommunication(targetList);
	}

	public void addCommunication(LanguageCompetency arg) {
		this.adaptee.addCommunication(((org.reimagineehr.model.quick.stu3.wrapper.backbone.LanguageCompetencyWrapper)arg).getAdaptee());
	}

	public List<CareGiver> getGeneralPractitioner() {
		java.util.List<CareGiver> returnValue = new java.util.ArrayList<>();
		java.util.List<org.hl7.fhir.dstu3.model.Reference> references = this.adaptee.getGeneralPractitioner();
		for(org.hl7.fhir.dstu3.model.Reference reference : references) {
			...
			if(resource == null) {
				...
				if(resource instanceof org.hl7.fhir.dstu3.model.Organization) {
					returnValue.add(new org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper((org.hl7.fhir.dstu3.model.Organization) resource));
				}
				else if(resource instanceof org.hl7.fhir.dstu3.model.Practitioner) {
					returnValue.add(new org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper((org.hl7.fhir.dstu3.model.Practitioner) resource));
				}
			}
			return returnValue;
	}
	...
	for(CareGiver item : arg) {
		...
		if(item instanceof org.hl7.fhir.dstu3.model.Organization) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper)item).getAdaptee());
			this.adaptee.addGeneralPractitioner(reference);
		} else if(item instanceof org.hl7.fhir.dstu3.model.Practitioner) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper)item).getAdaptee());
			this.adaptee.addGeneralPractitioner(reference);
		}
	}
	}
	...
	public void addGeneralPractitioner(CareGiver arg) {
		...
		org.hl7.fhir.dstu3.model.Reference reference = new org.hl7.fhir.dstu3.model.Reference();
		if(arg instanceof org.hl7.fhir.dstu3.model.Organization) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper)arg).getAdaptee());
			this.adaptee.addGeneralPractitioner(reference);
		} else if(arg instanceof org.hl7.fhir.dstu3.model.Practitioner) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper)arg).getAdaptee());
			this.adaptee.addGeneralPractitioner(reference);
		}
	}

	public Organization getManagingOrganization() {
		return new org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper((org.hl7.fhir.dstu3.model.Organization)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getManagingOrganization()).getResource());
	}

	public void setManagingOrganization(Organization arg) {
		this.adaptee.setManagingOrganization(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper)arg).getAdaptee()));
	}
	...
	public List<RecordLink> getLink() {
		...
		List<org.hl7.fhir.dstu3.model.Patient.PatientLinkComponent> items = this.adaptee.getLink();
		for(org.hl7.fhir.dstu3.model.Patient.PatientLinkComponent item : items) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.RecordLinkWrapper(item));
		}
		return returnList;
	}

	public void setLink(java.util.List<RecordLink> arg) {
		List<org.hl7.fhir.dstu3.model.Patient.PatientLinkComponent> targetList = new java.util.ArrayList<>();
		for(org.reimagineehr.model.quick.api.backbone.RecordLink item : arg) {
			targetList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.RecordLinkWrapper)item).getAdaptee());
		}
		this.adaptee.setLink(targetList);
	}

	public void addLink(RecordLink arg) {
		this.adaptee.addLink(((org.reimagineehr.model.quick.stu3.wrapper.backbone.RecordLinkWrapper)arg).getAdaptee());
	}
