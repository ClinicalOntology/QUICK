...
public class SampledDataWrapper implements SampledData {
	...
	public SimpleQuantity getOrigin() {
		...
		return new org.reimagineehr.model.quick.stu3.wrapper.datatype.SimpleQuantityWrapper(this.adaptee.getOrigin());
	}

	public void setOrigin(SimpleQuantity arg) {
	
		this.adaptee.setOrigin(((org.reimagineehr.model.quick.stu3.wrapper.datatype.SimpleQuantityWrapper)arg).getAdaptee());
	}
