...
public class RatioWrapper implements Ratio {
	...
	public Quantity getNumerator() {
		...
		return new org.reimagineehr.model.quick.stu3.wrapper.datatype.QuantityWrapper(this.adaptee.getNumerator());
	}

	public void setNumerator(Quantity arg) {
	
		this.adaptee.setNumerator(((org.reimagineehr.model.quick.stu3.wrapper.datatype.QuantityWrapper)arg).getAdaptee());
	}

	public Quantity getDenominator() {
	
		return new org.reimagineehr.model.quick.stu3.wrapper.datatype.QuantityWrapper(this.adaptee.getDenominator());
	}

	public void setDenominator(Quantity arg) {
	
		this.adaptee.setDenominator(((org.reimagineehr.model.quick.stu3.wrapper.datatype.QuantityWrapper)arg).getAdaptee());
	}
