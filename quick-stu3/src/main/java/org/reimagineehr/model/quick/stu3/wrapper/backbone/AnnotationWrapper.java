	...
	public void setAuthor(ResourceOrStringChoice arg) {
		...
		if(domainResource != null) {
			if  (domainResource != null && domainResource instanceof org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper) {
				this.adaptee.setAuthor(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper) domainResource).getAdaptee()));
			} else if (domainResource != null && domainResource instanceof org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper) {
				this.adaptee.setAuthor(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper) domainResource).getAdaptee()));
				...
				this.adaptee.setAuthor(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.RelatedPersonWrapper) domainResource).getAdaptee()));
				...
				this.adaptee.setAuthor(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper) domainResource).getAdaptee()));
			} else { throw new RuntimeException("Unsupported resource type");}
