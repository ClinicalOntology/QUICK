package org.reimagineehr.model.quick.stu3.wrapper.event;
...
public class ProcedureWrapper implements Procedure {
	...
	public List<Participation> getPerformer() {
		...
		for(org.hl7.fhir.dstu3.model.Procedure.ProcedurePerformerComponent item : itemList) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.ProcedurePerformerWrapper(item));	}
		return returnList;
	}
	...
	public void setPerformer(java.util.List<Participation> arg) {
		...
		for(Participation item : arg) {
			itemList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.ProcedurePerformerWrapper)item).getAdaptee());
		}
		this.adaptee.setPerformer(itemList);
	}

	public void addPerformer(Participation arg) {
	this.adaptee.getPerformer().add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.ProcedurePerformerWrapper)arg).getAdaptee());
	}
		...
		for(org.hl7.fhir.dstu3.model.Reference reference : references) {
			...
			if(resource == null) {
				...
				if(resource instanceof org.hl7.fhir.dstu3.model.Condition) {
					returnValue.add(new org.reimagineehr.model.quick.stu3.wrapper.finding.ConditionWrapper((org.hl7.fhir.dstu3.model.Condition) resource));
				}
				else if(resource instanceof org.hl7.fhir.dstu3.model.Observation) {
					returnValue.add(new org.reimagineehr.model.quick.stu3.wrapper.finding.ObservationWrapper((org.hl7.fhir.dstu3.model.Observation) resource));
				}
			}
			return returnValue;
	}
	...
	for(Finding item : arg) {
		...
		if(item instanceof org.hl7.fhir.dstu3.model.Condition) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.finding.ConditionWrapper)item).getAdaptee());
			this.adaptee.addReasonReference(reference);
		} else if(item instanceof org.hl7.fhir.dstu3.model.Observation) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.finding.ObservationWrapper)item).getAdaptee());
			this.adaptee.addReasonReference(reference);
		}
	}
	}
	...
	public void addReasonReference(Finding arg) {
		...
		if(arg instanceof org.hl7.fhir.dstu3.model.Condition) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.finding.ConditionWrapper)arg).getAdaptee());
			this.adaptee.addReasonReference(reference);
		} else if(arg instanceof org.hl7.fhir.dstu3.model.Observation) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.finding.ObservationWrapper)arg).getAdaptee());
			this.adaptee.addReasonReference(reference);
		}
	}
	...
	public OccurrenceAllChoice getOccurrence() {
		...
		if(type instanceof org.hl7.fhir.dstu3.model.DateTimeType) {
			...
			choice = new org.reimagineehr.model.quick.stu3.wrapper.datatype.AgeWrapper((org.hl7.fhir.dstu3.model.Age)type);
	...
	public void setOccurrence(OccurrenceAllChoice arg) {
		...
		if(choice.getDateTime() != null) {
			...
			this.adaptee.setPerformed(((org.reimagineehr.model.quick.stu3.wrapper.datatype.PeriodWrapper)choice.getPeriod()).getAdaptee());
			...
			this.adaptee.setPerformed(((org.reimagineehr.model.quick.stu3.wrapper.datatype.AgeWrapper)choice.getAge()).getAdaptee());
		}else if(choice.getRange() != null) {
			this.adaptee.setPerformed(((org.reimagineehr.model.quick.stu3.wrapper.datatype.RangeWrapper)choice.getRange()).getAdaptee());
		}
	}
		...
		for(org.hl7.fhir.dstu3.model.Reference reference : references) {
			...
			if(resource == null) {
				...
				if(resource instanceof org.hl7.fhir.dstu3.model.CarePlan) {
					returnValue.add(new org.reimagineehr.model.quick.stu3.wrapper.request.CarePlanWrapper((org.hl7.fhir.dstu3.model.CarePlan) resource));
				}
	...
	for(Request item : arg) {
		...
		if(item instanceof org.hl7.fhir.dstu3.model.CarePlan) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.request.CarePlanWrapper)item).getAdaptee());
	...
	public void addBasedOn(Request arg) {
		...
		if(arg instanceof org.hl7.fhir.dstu3.model.CarePlan) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.request.CarePlanWrapper)arg).getAdaptee());
			this.adaptee.addBasedOn(reference);
	...
	return new org.reimagineehr.model.quick.stu3.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getOutcome());
	}
		...
		for(org.hl7.fhir.dstu3.model.Reference reference : references) {
			...
			if(resource == null) {
				...
				if(resource instanceof org.hl7.fhir.dstu3.model.Procedure) {
					returnValue.add(new org.reimagineehr.model.quick.stu3.wrapper.event.ProcedureWrapper((org.hl7.fhir.dstu3.model.Procedure) resource));
				}
				else if(resource instanceof org.hl7.fhir.dstu3.model.MedicationAdministration) {
					returnValue.add(new org.reimagineehr.model.quick.stu3.wrapper.event.MedicationAdministrationWrapper((org.hl7.fhir.dstu3.model.MedicationAdministration) resource));
				}
				else if(resource instanceof org.hl7.fhir.dstu3.model.Observation) {
					returnValue.add(new org.reimagineehr.model.quick.stu3.wrapper.finding.ObservationWrapper((org.hl7.fhir.dstu3.model.Observation) resource));
				}
	...
	for(Event item : arg) {
		...
		if(item instanceof org.hl7.fhir.dstu3.model.Procedure) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.event.ProcedureWrapper)item).getAdaptee());
			this.adaptee.addPartOf(reference);
		} else if(item instanceof org.hl7.fhir.dstu3.model.MedicationAdministration) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.event.MedicationAdministrationWrapper)item).getAdaptee());
			this.adaptee.addPartOf(reference);
		} else if(item instanceof org.hl7.fhir.dstu3.model.Observation) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.finding.ObservationWrapper)item).getAdaptee());
			this.adaptee.addPartOf(reference);
	...
	public void addPartOf(Event arg) {
		...
		if(arg instanceof org.hl7.fhir.dstu3.model.Procedure) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.event.ProcedureWrapper)arg).getAdaptee());
			this.adaptee.addPartOf(reference);
		} else if(arg instanceof org.hl7.fhir.dstu3.model.MedicationAdministration) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.event.MedicationAdministrationWrapper)arg).getAdaptee());
			this.adaptee.addPartOf(reference);
		} else if(arg instanceof org.hl7.fhir.dstu3.model.Observation) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.finding.ObservationWrapper)arg).getAdaptee());
			this.adaptee.addPartOf(reference);
