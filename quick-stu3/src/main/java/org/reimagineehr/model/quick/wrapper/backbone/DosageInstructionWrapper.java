...
public class DosageInstructionWrapper implements DosageInstruction {
	...
	public List<DoseAndRate> getDoseAndRate() {
		...
		if(type0 instanceof org.hl7.fhir.dstu3.model.SimpleQuantity) {
			choice0 = new org.reimagineehr.model.quick.wrapper.datatype.SimpleQuantityWrapper((org.hl7.fhir.dstu3.model.SimpleQuantity)type0);
		} else if(type0 instanceof org.hl7.fhir.dstu3.model.Range) {
			choice0 = new org.reimagineehr.model.quick.wrapper.datatype.RangeWrapper((org.hl7.fhir.dstu3.model.Range)type0);
		}
		...
		if(type1 instanceof org.hl7.fhir.dstu3.model.SimpleQuantity) {
			choice1 = new org.reimagineehr.model.quick.wrapper.datatype.SimpleQuantityWrapper((org.hl7.fhir.dstu3.model.SimpleQuantity)type1);
		} else if(type1 instanceof org.hl7.fhir.dstu3.model.Range) {
			choice1 = new org.reimagineehr.model.quick.wrapper.datatype.RangeWrapper((org.hl7.fhir.dstu3.model.Range)type1);
		} else if(type1 instanceof org.hl7.fhir.dstu3.model.Ratio) {
			choice1 = new org.reimagineehr.model.quick.wrapper.datatype.RatioWrapper((org.hl7.fhir.dstu3.model.Ratio)type1);
		}
	...
	public void setDoseAndRate(java.util.List<DoseAndRate> arg) {
		...
		if(choice0.getSimpleQuantity() != null) {
			this.adaptee.setDose(((org.reimagineehr.model.quick.wrapper.datatype.SimpleQuantityWrapper)choice0.getSimpleQuantity()).getAdaptee());
		}else if(choice0.getRange() != null) {
			this.adaptee.setDose(((org.reimagineehr.model.quick.wrapper.datatype.RangeWrapper)choice0.getRange()).getAdaptee());
		}
		item.setDose(new org.reimagineehr.model.quick.impl.choice.QuantityRangeRatioOrStringChoiceImpl(choice0));
		...
		if(choice1.getSimpleQuantity() != null) {
			this.adaptee.setRate(((org.reimagineehr.model.quick.wrapper.datatype.SimpleQuantityWrapper)choice1.getSimpleQuantity()).getAdaptee());
		}else if(choice1.getRange() != null) {
			this.adaptee.setRate(((org.reimagineehr.model.quick.wrapper.datatype.RangeWrapper)choice1.getRange()).getAdaptee());
		}else if(choice1.getRatio() != null) {
			this.adaptee.setRate(((org.reimagineehr.model.quick.wrapper.datatype.RatioWrapper)choice1.getRatio()).getAdaptee());
		}
		item.setRate(new org.reimagineehr.model.quick.impl.choice.QuantityRangeRatioOrStringChoiceImpl(choice1));
	...
	public Timing getTiming() {
		...
		return new org.reimagineehr.model.quick.wrapper.backbone.TimingWrapper(this.adaptee.getTiming());
	}

	public void setTiming(Timing arg) {
	
		this.adaptee.setTiming(((org.reimagineehr.model.quick.wrapper.backbone.TimingWrapper)arg).getAdaptee());
	}

	public CodeableConcept getRoute() {
	return new org.reimagineehr.model.quick.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getRoute());
	}
