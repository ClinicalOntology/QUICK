...
public class MedicationStatementWrapper implements MedicationStatement {
	...
	public List<DosageInstruction> getDosage() {
		...
		for(org.hl7.fhir.dstu3.model.Dosage item : items) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.DosageInstructionWrapper(item));
		}
		return returnList;
	}
	...
	public void setDosage(java.util.List<DosageInstruction> arg) {
		...
		for(org.reimagineehr.model.quick.api.backbone.DosageInstruction item : arg) {
			targetList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.DosageInstructionWrapper)item).getAdaptee());
		}
		this.adaptee.setDosage(targetList);
	}

	public void addDosage(DosageInstruction arg) {
		this.adaptee.addDosage(((org.reimagineehr.model.quick.stu3.wrapper.backbone.DosageInstructionWrapper)arg).getAdaptee());
	}

	public Medication getMedication() {
		return new org.reimagineehr.model.quick.stu3.wrapper.other.MedicationWrapper((org.hl7.fhir.dstu3.model.Medication)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getMedication()).getResource());
	}

	public void setMedication(Medication arg) {
		this.adaptee.setMedication(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.other.MedicationWrapper)arg).getAdaptee()));
	}
	...
	public Party getInformationSource() {
		...
		org.hl7.fhir.dstu3.model.Resource resource = (org.hl7.fhir.dstu3.model.Resource)reference.getResource();
		if(resource instanceof org.hl7.fhir.dstu3.model.Patient) { returnValue = new org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper((org.hl7.fhir.dstu3.model.Patient)resource);}
		else if(resource instanceof org.hl7.fhir.dstu3.model.Practitioner) { returnValue = new org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper((org.hl7.fhir.dstu3.model.Practitioner)resource);}
