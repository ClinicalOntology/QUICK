...
public class ConditionWrapper implements Condition {
	...
	public Party getRecorder() {
		...
		if(extensions != null && extensions.size() > 0) {
			...
			if  (domainResource != null && domainResource instanceof org.hl7.fhir.dstu3.model.Practitioner) {
				 return new org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper((org.hl7.fhir.dstu3.model.Practitioner)domainResource);
			} else if (domainResource != null && domainResource instanceof org.hl7.fhir.dstu3.model.PractitionerRole) {
				 return new org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerRoleWrapper((org.hl7.fhir.dstu3.model.PractitionerRole)domainResource);
			} else if (domainResource != null && domainResource instanceof org.hl7.fhir.dstu3.model.Patient) {
				 return new org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper((org.hl7.fhir.dstu3.model.Patient)domainResource);
			} else if (domainResource != null && domainResource instanceof org.hl7.fhir.dstu3.model.RelatedPerson) {
				 return new org.reimagineehr.model.quick.stu3.wrapper.party.RelatedPersonWrapper((org.hl7.fhir.dstu3.model.RelatedPerson)domainResource);
	...
	public void setRecorder(Party arg) {
		...
		if  (arg != null && arg instanceof org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper) {
			extension.setValue(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper) arg).getAdaptee()));
		} else if (arg != null && arg instanceof org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerRoleWrapper) {
			extension.setValue(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerRoleWrapper) arg).getAdaptee()));
		} else if (arg != null && arg instanceof org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper) {
			extension.setValue(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper) arg).getAdaptee()));
		} else if (arg != null && arg instanceof org.reimagineehr.model.quick.stu3.wrapper.party.RelatedPersonWrapper) {
			extension.setValue(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.RelatedPersonWrapper) arg).getAdaptee()));
		} else { throw new RuntimeException("Unsupported resource type");}
	}
	...
	public void setOnset(OnsetAbatementChoice arg) {
		...
		if(choice.getDateTime() != null) {
			...
			this.adaptee.setOnset(((org.reimagineehr.model.quick.stu3.wrapper.datatype.AgeWrapper)choice.getAge()).getAdaptee());
		}else if(choice.getPeriod() != null) {
			this.adaptee.setOnset(((org.reimagineehr.model.quick.stu3.wrapper.datatype.PeriodWrapper)choice.getPeriod()).getAdaptee());
		}else if(choice.getRange() != null) {
			this.adaptee.setOnset(((org.reimagineehr.model.quick.stu3.wrapper.datatype.RangeWrapper)choice.getRange()).getAdaptee());
	...
	public void setAbatement(OnsetAbatementChoice arg) {
		...
		if(choice.getDateTime() != null) {
			...
			this.adaptee.setAbatement(((org.reimagineehr.model.quick.stu3.wrapper.datatype.AgeWrapper)choice.getAge()).getAdaptee());
		}else if(choice.getPeriod() != null) {
			this.adaptee.setAbatement(((org.reimagineehr.model.quick.stu3.wrapper.datatype.PeriodWrapper)choice.getPeriod()).getAdaptee());
		}else if(choice.getRange() != null) {
			this.adaptee.setAbatement(((org.reimagineehr.model.quick.stu3.wrapper.datatype.RangeWrapper)choice.getRange()).getAdaptee());
		}else if(choice.getString() != null) {
	...
	return new org.reimagineehr.model.quick.stu3.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getSeverity());
	}
