...
public class MedicationAdministrationWrapper implements MedicationAdministration {
	...
	public List<Participation> getPerformer() {
		...
		for(org.hl7.fhir.dstu3.model.MedicationAdministration.MedicationAdministrationPerformerComponent item : itemList) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.MedicationAdministrationPerformerWrapper(item));	}
		return returnList;
	}
	...
	public void setPerformer(java.util.List<Participation> arg) {
		...
		for(Participation item : arg) {
			itemList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.MedicationAdministrationPerformerWrapper)item).getAdaptee());
		}
		this.adaptee.setPerformer(itemList);
	}

	public void addPerformer(Participation arg) {
	this.adaptee.getPerformer().add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.MedicationAdministrationPerformerWrapper)arg).getAdaptee());
	}
	...
	public DosageTaken getDosage() {
		...
		return new org.reimagineehr.model.quick.stu3.wrapper.backbone.DosageTakenWrapper(this.adaptee.getDosage());
	}

	public void setDosage(DosageTaken arg) {
	
		this.adaptee.setDosage(((org.reimagineehr.model.quick.stu3.wrapper.backbone.DosageTakenWrapper)arg).getAdaptee());
	}
