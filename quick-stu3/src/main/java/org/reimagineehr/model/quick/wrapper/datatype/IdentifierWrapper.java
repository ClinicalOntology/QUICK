...
public class IdentifierWrapper implements Identifier {
	...
	public Organization getAssigner() {
		return new org.reimagineehr.model.quick.wrapper.party.OrganizationWrapper((org.hl7.fhir.dstu3.model.Organization)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getAssigner()).getResource());
	}

	public void setAssigner(Organization arg) {
		this.adaptee.setAssigner(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.wrapper.party.OrganizationWrapper)arg).getAdaptee()));
	}
