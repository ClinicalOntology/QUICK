...
public class TimingWrapper implements Timing {
	...
	public TimingRepeat getRepeat() {
		...
		return new org.reimagineehr.model.quick.wrapper.backbone.TimingRepeatWrapper(this.adaptee.getRepeat());
	}

	public void setRepeat(TimingRepeat arg) {
	
		this.adaptee.setRepeat(((org.reimagineehr.model.quick.wrapper.backbone.TimingRepeatWrapper)arg).getAdaptee());
	}
