...
public class DeviceWrapper implements Device {
	...
	public List<DeviceUdiCarrier> getUdiCarrier() {
		...
		org.hl7.fhir.dstu3.model.Device.DeviceUdiComponent item = this.adaptee.getUdi();
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.DeviceUdiCarrierWrapper(item));
		return returnList;
	}
	...
	public void setUdiCarrier(java.util.List<DeviceUdiCarrier> arg) {
		...
		if(arg != null && arg.size() > 0) {
			if(arg.size() == 1) {
				value = ((org.reimagineehr.model.quick.stu3.wrapper.backbone.DeviceUdiCarrierWrapper)arg.get(0)).getAdaptee();
			} else {
	...
	public Patient getPatient() {
		return new org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper((org.hl7.fhir.dstu3.model.Patient)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getPatient()).getResource());
	}

	public void setPatient(Patient arg) {
		this.adaptee.setPatient(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper)arg).getAdaptee()));
	}

	public Organization getOwner() {
		return new org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper((org.hl7.fhir.dstu3.model.Organization)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getOwner()).getResource());
	}

	public void setOwner(Organization arg) {
		this.adaptee.setOwner(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper)arg).getAdaptee()));
	}
	...
	public void addContact(ContactPoint arg) {
		this.adaptee.addContact(((org.reimagineehr.model.quick.stu3.wrapper.backbone.ContactPointWrapper)arg).getAdaptee());
	}
	...
	public List<Annotation> getNote() {
		...
		for(org.hl7.fhir.dstu3.model.Annotation item : items) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.AnnotationWrapper(item));
		}
		return returnList;
	}
	...
	public void setNote(java.util.List<Annotation> arg) {
		...
		for(org.reimagineehr.model.quick.api.backbone.Annotation item : arg) {
			targetList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.AnnotationWrapper)item).getAdaptee());
		}
		this.adaptee.setNote(targetList);
	}

	public void addNote(Annotation arg) {
		this.adaptee.addNote(((org.reimagineehr.model.quick.stu3.wrapper.backbone.AnnotationWrapper)arg).getAdaptee());
	}
