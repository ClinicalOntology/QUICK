...
public class PractitionerRoleWrapper implements PractitionerRole {
	...
	private org.hl7.fhir.dstu3.model.PractitionerRole adaptee;

	public PractitionerRoleWrapper() {
	
	}

	public PractitionerRoleWrapper(org.hl7.fhir.dstu3.model.PractitionerRole adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.dstu3.model.PractitionerRole getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.dstu3.model.PractitionerRole arg) {
		this.adaptee=arg;
	}
	...
	public Practitioner getPractitioner() {
		return new org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper((org.hl7.fhir.dstu3.model.Practitioner)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getPractitioner()).getResource());
	}

	public void setPractitioner(Practitioner arg) {
		this.adaptee.setPractitioner(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper)arg).getAdaptee()));
	}

	public Organization getOrganization() {
		return new org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper((org.hl7.fhir.dstu3.model.Organization)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getOrganization()).getResource());
	}

	public void setOrganization(Organization arg) {
		this.adaptee.setOrganization(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper)arg).getAdaptee()));
	}

	public List<CodeableConcept> getCode() {
		return org.reimagineehr.model.quick.utils.Stu3Utils.getAsQuickCodeableConcept(this.adaptee.getCode());
	}
	...
	public void addCode(CodeableConcept arg) {
		this.adaptee.addCode(org.reimagineehr.model.quick.utils.Stu3Utils.getAsFhirCodeableConcept(arg));
	}

	public List<CodeableConcept> getSpecialty() {
		return org.reimagineehr.model.quick.utils.Stu3Utils.getAsQuickCodeableConcept(this.adaptee.getSpecialty());
	}

	public void setSpecialty(java.util.List<CodeableConcept> arg) {
		this.adaptee.setSpecialty(org.reimagineehr.model.quick.utils.Stu3Utils.getAsFhirCodeableConcept(arg));
	}

	public void addSpecialty(CodeableConcept arg) {
		this.adaptee.addSpecialty(org.reimagineehr.model.quick.utils.Stu3Utils.getAsFhirCodeableConcept(arg));
	}
