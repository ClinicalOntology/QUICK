...
public class HumanNameWrapper implements HumanName {
	...
	private org.hl7.fhir.dstu3.model.HumanName adaptee;

	public HumanNameWrapper() {
	
	}

	public HumanNameWrapper(org.hl7.fhir.dstu3.model.HumanName adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.dstu3.model.HumanName getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.dstu3.model.HumanName arg) {
		this.adaptee=arg;
	}
	...
	public void setUse(String arg) {
		if (arg != null) {
			this.adaptee.setUse(org.hl7.fhir.dstu3.model.HumanName.NameUse.fromCode(arg));
		}
	}
	...
	public List<String> getGiven() {
		...
		if(this.adaptee.getGiven() != null) {
			for(org.hl7.fhir.dstu3.model.StringType type: this.adaptee.getGiven()) {
	...
	public List<String> getPrefix() {
		...
		if(this.adaptee.getPrefix() != null) {
			for(org.hl7.fhir.dstu3.model.StringType type: this.adaptee.getPrefix()) {
				retVals.add(type.getValueAsString());
			}
		}
		return retVals;
	...
	public List<String> getSuffix() {
		...
		if(this.adaptee.getSuffix() != null) {
			for(org.hl7.fhir.dstu3.model.StringType type: this.adaptee.getSuffix()) {
				retVals.add(type.getValueAsString());
			}
		}
		return retVals;
