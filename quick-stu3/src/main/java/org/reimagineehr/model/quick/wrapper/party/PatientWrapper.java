...
public class PatientWrapper implements Patient {
	...
	return new org.reimagineehr.model.quick.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getMaritalStatus());
	}
	...
	public List<IndividualContact> getContact() {
		...
		for(org.hl7.fhir.dstu3.model.Patient.ContactComponent item : items) {
			returnList.add(new org.reimagineehr.model.quick.wrapper.backbone.IndividualContactWrapper(item));
		}
		return returnList;
	}
	...
	public void setContact(java.util.List<IndividualContact> arg) {
		...
		for(org.reimagineehr.model.quick.api.backbone.IndividualContact item : arg) {
			targetList.add(((org.reimagineehr.model.quick.wrapper.backbone.IndividualContactWrapper)item).getAdaptee());
		}
		this.adaptee.setContact(targetList);
	}

	public void addContact(IndividualContact arg) {
		this.adaptee.addContact(((org.reimagineehr.model.quick.wrapper.backbone.IndividualContactWrapper)arg).getAdaptee());
	}
	...
	public List<LanguageCompetency> getCommunication() {
		...
		for(org.hl7.fhir.dstu3.model.Patient.PatientCommunicationComponent item : items) {
			returnList.add(new org.reimagineehr.model.quick.wrapper.backbone.LanguageCompetencyWrapper(item));
		}
		return returnList;
	}
	...
	public void setCommunication(java.util.List<LanguageCompetency> arg) {
		...
		for(org.reimagineehr.model.quick.api.backbone.LanguageCompetency item : arg) {
			targetList.add(((org.reimagineehr.model.quick.wrapper.backbone.LanguageCompetencyWrapper)item).getAdaptee());
		}
		this.adaptee.setCommunication(targetList);
	}

	public void addCommunication(LanguageCompetency arg) {
		this.adaptee.addCommunication(((org.reimagineehr.model.quick.wrapper.backbone.LanguageCompetencyWrapper)arg).getAdaptee());
	}
		...
		for(org.hl7.fhir.dstu3.model.Reference reference : references) {
			...
			if(resource == null) {
				...
				if(resource instanceof org.hl7.fhir.dstu3.model.Organization) {
					returnValue.add(new org.reimagineehr.model.quick.wrapper.party.OrganizationWrapper((org.hl7.fhir.dstu3.model.Organization) resource));
				}
				else if(resource instanceof org.hl7.fhir.dstu3.model.Practitioner) {
					returnValue.add(new org.reimagineehr.model.quick.wrapper.party.PractitionerWrapper((org.hl7.fhir.dstu3.model.Practitioner) resource));
				}
			}
			return returnValue;
	}
	...
	for(CareGiver item : arg) {
		...
		if(item instanceof org.hl7.fhir.dstu3.model.Organization) {
			reference.setResource(((org.reimagineehr.model.quick.wrapper.party.OrganizationWrapper)item).getAdaptee());
			this.adaptee.addGeneralPractitioner(reference);
		} else if(item instanceof org.hl7.fhir.dstu3.model.Practitioner) {
			reference.setResource(((org.reimagineehr.model.quick.wrapper.party.PractitionerWrapper)item).getAdaptee());
			this.adaptee.addGeneralPractitioner(reference);
		}
	}
	}
	...
	public Organization getManagingOrganization() {
		return new org.reimagineehr.model.quick.wrapper.party.OrganizationWrapper((org.hl7.fhir.dstu3.model.Organization)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getManagingOrganization()).getResource());
	}

	public void setManagingOrganization(Organization arg) {
		this.adaptee.setManagingOrganization(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.wrapper.party.OrganizationWrapper)arg).getAdaptee()));
	}
	...
	public List<RecordLink> getLink() {
		...
		for(org.hl7.fhir.dstu3.model.Patient.PatientLinkComponent item : items) {
			returnList.add(new org.reimagineehr.model.quick.wrapper.backbone.RecordLinkWrapper(item));
		}
		return returnList;
	}
	...
	public void setLink(java.util.List<RecordLink> arg) {
		...
		for(org.reimagineehr.model.quick.api.backbone.RecordLink item : arg) {
			targetList.add(((org.reimagineehr.model.quick.wrapper.backbone.RecordLinkWrapper)item).getAdaptee());
		}
		this.adaptee.setLink(targetList);
	}

	public void addLink(RecordLink arg) {
		this.adaptee.addLink(((org.reimagineehr.model.quick.wrapper.backbone.RecordLinkWrapper)arg).getAdaptee());
	}
