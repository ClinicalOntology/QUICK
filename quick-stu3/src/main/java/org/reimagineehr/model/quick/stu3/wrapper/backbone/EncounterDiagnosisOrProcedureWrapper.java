...
public class EncounterDiagnosisOrProcedureWrapper implements EncounterDiagnosisOrProcedure {
	...
	public ConditionOrProcedureChoice getReference() {
		...
		if(type instanceof org.hl7.fhir.dstu3.model.Condition) {
			choice = new org.reimagineehr.model.quick.stu3.wrapper.finding.ConditionWrapper((org.hl7.fhir.dstu3.model.Condition)type);
		} else if(type instanceof org.hl7.fhir.dstu3.model.Procedure) {
			choice = new org.reimagineehr.model.quick.stu3.wrapper.event.ProcedureWrapper((org.hl7.fhir.dstu3.model.Procedure)type);
		}
	...
	public void setReference(ConditionOrProcedureChoice arg) {
		...
		if(choice.getCondition() != null) {
			this.adaptee.setCondition(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.finding.ConditionWrapper)choice.getCondition()).getAdaptee()));
		}else if(choice.getProcedure() != null) {
			this.adaptee.setCondition(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.event.ProcedureWrapper)choice.getProcedure()).getAdaptee()));
		}
	}

	public CodeableConcept getUse() {
	return new org.reimagineehr.model.quick.stu3.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getRole());
	}
