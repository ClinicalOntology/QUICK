...
public class AttachmentWrapper implements Attachment {
	...
	private org.hl7.fhir.dstu3.model.Attachment adaptee;

	public AttachmentWrapper() {
	
	}

	public AttachmentWrapper(org.hl7.fhir.dstu3.model.Attachment adaptee) {
		this.adaptee = adaptee;
	}

	public org.hl7.fhir.dstu3.model.Attachment getAdaptee() {
		return this.adaptee;
	}

	public void setAdaptee(org.hl7.fhir.dstu3.model.Attachment arg) {
		this.adaptee=arg;
	}
