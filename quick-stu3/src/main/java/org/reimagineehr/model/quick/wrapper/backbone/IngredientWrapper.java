...
public class IngredientWrapper implements Ingredient {
	...
	public void setItem(ResourceOrCodeChoice arg) {
		...
		if(domainResource != null) {
			if  (domainResource != null && domainResource instanceof org.reimagineehr.model.quick.wrapper.other.MedicationWrapper) {
				this.adaptee.setItem(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.wrapper.other.MedicationWrapper) domainResource).getAdaptee()));
			} else { throw new RuntimeException("Unsupported resource type");}
	...
	public Ratio getStrength() {
		...
		return new org.reimagineehr.model.quick.wrapper.datatype.RatioWrapper(this.adaptee.getAmount());
	}

	public void setStrength(Ratio arg) {
	
		this.adaptee.setAmount(((org.reimagineehr.model.quick.wrapper.datatype.RatioWrapper)arg).getAdaptee());
	}
