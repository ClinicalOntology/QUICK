...
public class MedicationRequestWrapper implements MedicationRequest {
	...
	public Party getRequester() {
		...
		if(agentResource != null) {
			if  (agentResource instanceof org.hl7.fhir.dstu3.model.Practitioner) {
				retVal = new org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper((org.hl7.fhir.dstu3.model.Practitioner) agentResource);
			} else if (agentResource instanceof org.hl7.fhir.dstu3.model.Patient) {
				retVal = new org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper((org.hl7.fhir.dstu3.model.Patient) agentResource);
			} else if (agentResource instanceof org.hl7.fhir.dstu3.model.RelatedPerson) {
				retVal = new org.reimagineehr.model.quick.stu3.wrapper.party.RelatedPersonWrapper((org.hl7.fhir.dstu3.model.RelatedPerson) agentResource);
			} else if (agentResource instanceof org.hl7.fhir.dstu3.model.Device) {
				retVal = new org.reimagineehr.model.quick.stu3.wrapper.party.DeviceWrapper((org.hl7.fhir.dstu3.model.Device) agentResource);
			} else if (agentResource instanceof org.hl7.fhir.dstu3.model.Organization) {
				retVal = new org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper((org.hl7.fhir.dstu3.model.Organization) agentResource);
	...
	public void setRequester(Party arg) {
		...
		if(arg != null) {
			...
			if  (arg instanceof org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper) {
			...
			} else if (arg instanceof org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper) {
				reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper)arg).getAdaptee());
				hapiType.setAgent(reference);
			} else if (arg instanceof org.reimagineehr.model.quick.stu3.wrapper.party.RelatedPersonWrapper) {
				reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.RelatedPersonWrapper)arg).getAdaptee());
				hapiType.setAgent(reference);
			} else if (arg instanceof org.reimagineehr.model.quick.stu3.wrapper.party.DeviceWrapper) {
				reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.DeviceWrapper)arg).getAdaptee());
				hapiType.setAgent(reference);
			} else if (arg instanceof org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper) {
	...
	public void addDosageInstruction(DosageInstruction arg) {
		this.adaptee.addDosageInstruction(((org.reimagineehr.model.quick.stu3.wrapper.backbone.DosageInstructionWrapper)arg).getAdaptee());
	}

	public DispenseRequest getDispenseRequest() {
	
		return new org.reimagineehr.model.quick.stu3.wrapper.backbone.DispenseRequestWrapper(this.adaptee.getDispenseRequest());
	}

	public void setDispenseRequest(DispenseRequest arg) {
	
		this.adaptee.setDispenseRequest(((org.reimagineehr.model.quick.stu3.wrapper.backbone.DispenseRequestWrapper)arg).getAdaptee());
	}
	...
	public void setMedication(MedicationOrCodeChoice arg) {
		...
		if(domainResource != null) {
			if  (domainResource != null && domainResource instanceof org.reimagineehr.model.quick.stu3.wrapper.other.MedicationWrapper) {
				this.adaptee.setMedication(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.other.MedicationWrapper) domainResource).getAdaptee()));
			} else { throw new RuntimeException("Unsupported resource type");}
