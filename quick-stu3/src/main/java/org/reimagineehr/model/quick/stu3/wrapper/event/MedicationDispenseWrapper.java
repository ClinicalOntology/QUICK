...
public class MedicationDispenseWrapper implements MedicationDispense {
	...
	public List<Participation> getPerformer() {
		...
		for(org.hl7.fhir.dstu3.model.MedicationDispense.MedicationDispensePerformerComponent item : itemList) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.MedicationDispensePerformerWrapper(item));	}
		return returnList;
	}
	...
	public void setPerformer(java.util.List<Participation> arg) {
		...
		for(Participation item : arg) {
			itemList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.MedicationDispensePerformerWrapper)item).getAdaptee());
		}
		this.adaptee.setPerformer(itemList);
	}

	public void addPerformer(Participation arg) {
	this.adaptee.getPerformer().add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.MedicationDispensePerformerWrapper)arg).getAdaptee());
	}
	...
	public SimpleQuantity getDaysSupply() {
		...
		return new org.reimagineehr.model.quick.stu3.wrapper.datatype.SimpleQuantityWrapper(this.adaptee.getDaysSupply());
	}

	public void setDaysSupply(SimpleQuantity arg) {
	
		this.adaptee.setDaysSupply(((org.reimagineehr.model.quick.stu3.wrapper.datatype.SimpleQuantityWrapper)arg).getAdaptee());
	}
