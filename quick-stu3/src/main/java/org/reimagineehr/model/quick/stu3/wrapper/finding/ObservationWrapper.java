package org.reimagineehr.model.quick.stu3.wrapper.finding;
...
public class ObservationWrapper implements Observation {
	...
	public CareRecipient getSubject() {
		...
		else if(resource instanceof org.hl7.fhir.dstu3.model.Group) { returnValue = new org.reimagineehr.model.quick.stu3.wrapper.party.GroupWrapper((org.hl7.fhir.dstu3.model.Group)resource);}
		return returnValue;
	}
	...
	public List<Participation> getPerformer() {
		...
		for(org.hl7.fhir.dstu3.model.Reference item : items) {
			...
			if  (resource instanceof org.hl7.fhir.dstu3.model.Practitioner) {
				source.setActor(new org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper((org.hl7.fhir.dstu3.model.Practitioner) resource));
			} else if (resource instanceof org.hl7.fhir.dstu3.model.Organization) {
				source.setActor(new org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper((org.hl7.fhir.dstu3.model.Organization) resource));
			} else if (resource instanceof org.hl7.fhir.dstu3.model.Patient) {
				source.setActor(new org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper((org.hl7.fhir.dstu3.model.Patient) resource));
			} else if (resource instanceof org.hl7.fhir.dstu3.model.RelatedPerson) {
				source.setActor(new org.reimagineehr.model.quick.stu3.wrapper.party.RelatedPersonWrapper((org.hl7.fhir.dstu3.model.RelatedPerson) resource));
	...
	public void setPerformer(java.util.List<Participation> arg) {
		...
		for(org.reimagineehr.model.quick.api.backbone.Participation item : arg) {
			...
			if  (item.getActor() instanceof org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper) {
				reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper) item.getActor()).getAdaptee());
				targetList.add(reference);
			} else if (item.getActor() instanceof org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper) {
				reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper) item.getActor()).getAdaptee());
				targetList.add(reference);
			} else if (item.getActor() instanceof org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper) {
				reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper) item.getActor()).getAdaptee());
				targetList.add(reference);
			} else if (item.getActor() instanceof org.reimagineehr.model.quick.stu3.wrapper.party.RelatedPersonWrapper) {
				reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.RelatedPersonWrapper) item.getActor()).getAdaptee());
				targetList.add(reference);
			} else {
	...
	public void addPerformer(Participation arg) {
		org.hl7.fhir.dstu3.model.Reference reference = new org.hl7.fhir.dstu3.model.Reference();
		if  (arg != null && arg.getActor() instanceof org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.PractitionerWrapper)arg.getActor()).getAdaptee());
		} else if (arg != null && arg.getActor() instanceof org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper)arg.getActor()).getAdaptee());
		} else if (arg != null && arg.getActor() instanceof org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.PatientWrapper)arg.getActor()).getAdaptee());
		} else if (arg != null && arg.getActor() instanceof org.reimagineehr.model.quick.stu3.wrapper.party.RelatedPersonWrapper) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.party.RelatedPersonWrapper)arg.getActor()).getAdaptee());
		} else {
			throw new RuntimeException("Invalid resource");
		}
	...
	public OccurrenceAllChoice getOccurrence() {
		...
		if(type instanceof org.hl7.fhir.dstu3.model.DateTimeType) {
			...
			choice = new org.reimagineehr.model.quick.stu3.wrapper.datatype.PeriodWrapper((org.hl7.fhir.dstu3.model.Period)type);
		}
	...
	public void setOccurrence(OccurrenceAllChoice arg) {
		...
		if(choice.getDateTime() != null) {
			...
			this.adaptee.setEffective(((org.reimagineehr.model.quick.stu3.wrapper.datatype.PeriodWrapper)choice.getPeriod()).getAdaptee());
		}
	}
		...
		for(org.hl7.fhir.dstu3.model.Reference reference : references) {
			...
			if(resource == null) {
				...
				if(resource instanceof org.hl7.fhir.dstu3.model.MedicationRequest) {
					returnValue.add(new org.reimagineehr.model.quick.stu3.wrapper.request.MedicationRequestWrapper((org.hl7.fhir.dstu3.model.MedicationRequest) resource));
				}
				else if(resource instanceof org.hl7.fhir.dstu3.model.ProcedureRequest) {
					returnValue.add(new org.reimagineehr.model.quick.stu3.wrapper.request.ServiceRequestWrapper((org.hl7.fhir.dstu3.model.ProcedureRequest) resource));
				}
				else if(resource instanceof org.hl7.fhir.dstu3.model.ReferralRequest) {
					returnValue.add(new org.reimagineehr.model.quick.stu3.wrapper.request.ReferralRequestWrapper((org.hl7.fhir.dstu3.model.ReferralRequest) resource));
				}
			}
			return returnValue;
	}
	...
	for(Request item : arg) {
		...
		if(item instanceof org.hl7.fhir.dstu3.model.MedicationRequest) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.request.MedicationRequestWrapper)item).getAdaptee());
			this.adaptee.addBasedOn(reference);
		} else if(item instanceof org.hl7.fhir.dstu3.model.ProcedureRequest) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.request.ServiceRequestWrapper)item).getAdaptee());
			this.adaptee.addBasedOn(reference);
		} else if(item instanceof org.hl7.fhir.dstu3.model.ReferralRequest) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.request.ReferralRequestWrapper)item).getAdaptee());
			this.adaptee.addBasedOn(reference);
		}
	}
	}
	...
	public void addBasedOn(Request arg) {
		...
		if(arg instanceof org.hl7.fhir.dstu3.model.MedicationRequest) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.request.MedicationRequestWrapper)arg).getAdaptee());
			this.adaptee.addBasedOn(reference);
		} else if(arg instanceof org.hl7.fhir.dstu3.model.ProcedureRequest) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.request.ServiceRequestWrapper)arg).getAdaptee());
			this.adaptee.addBasedOn(reference);
		} else if(arg instanceof org.hl7.fhir.dstu3.model.ReferralRequest) {
			reference.setResource(((org.reimagineehr.model.quick.stu3.wrapper.request.ReferralRequestWrapper)arg).getAdaptee());
			this.adaptee.addBasedOn(reference);
		}
	}
	...
	public ObservationValueChoice getValue() {
		...
		if(type instanceof org.hl7.fhir.dstu3.model.Quantity) {
			choice = new org.reimagineehr.model.quick.stu3.wrapper.datatype.QuantityWrapper((org.hl7.fhir.dstu3.model.Quantity)type);
		} else if(type instanceof org.hl7.fhir.dstu3.model.CodeableConcept) {
			choice = new org.reimagineehr.model.quick.stu3.wrapper.datatype.CodeableConceptWrapper((org.hl7.fhir.dstu3.model.CodeableConcept)type);
			...
			choice = new org.reimagineehr.model.quick.stu3.wrapper.datatype.RangeWrapper((org.hl7.fhir.dstu3.model.Range)type);
	...
	public void setValue(ObservationValueChoice arg) {
		...
		if(choice.getQuantity() != null) {
			this.adaptee.setValue(((org.reimagineehr.model.quick.stu3.wrapper.datatype.QuantityWrapper)choice.getQuantity()).getAdaptee());
		}else if(choice.getCodeableConcept() != null) {
			this.adaptee.setValue(((org.reimagineehr.model.quick.stu3.wrapper.datatype.CodeableConceptWrapper)choice.getCodeableConcept()).getAdaptee());
			...
			this.adaptee.setValue(((org.reimagineehr.model.quick.stu3.wrapper.datatype.RangeWrapper)choice.getRange()).getAdaptee());
		}else if(choice.getRatio() != null) {
			this.adaptee.setValue(((org.reimagineehr.model.quick.stu3.wrapper.datatype.RatioWrapper)choice.getRatio()).getAdaptee());
		}else if(choice.getDateTime() != null) {
			this.adaptee.setValue(new org.hl7.fhir.dstu3.model.DateTimeType(choice.getDateTime()));
		}else if(choice.getPeriod() != null) {
			this.adaptee.setValue(((org.reimagineehr.model.quick.stu3.wrapper.datatype.PeriodWrapper)choice.getPeriod()).getAdaptee());
		}
	}
	...
	public List<ObservationComponent> getComponent() {
		...
		for(org.hl7.fhir.dstu3.model.Observation.ObservationComponentComponent item : items) {
			returnList.add(new org.reimagineehr.model.quick.stu3.wrapper.backbone.ObservationComponentWrapper(item));
		}
		return returnList;
	}
	...
	public void setComponent(java.util.List<ObservationComponent> arg) {
		...
		for(org.reimagineehr.model.quick.api.backbone.ObservationComponent item : arg) {
			targetList.add(((org.reimagineehr.model.quick.stu3.wrapper.backbone.ObservationComponentWrapper)item).getAdaptee());
		}
		this.adaptee.setComponent(targetList);
	}

	public void addComponent(ObservationComponent arg) {
		this.adaptee.addComponent(((org.reimagineehr.model.quick.stu3.wrapper.backbone.ObservationComponentWrapper)arg).getAdaptee());
	}

	public CodeableConcept getBodySite() {
	return new org.reimagineehr.model.quick.stu3.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getBodySite());
	}
	...
	return new org.reimagineehr.model.quick.stu3.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getDataAbsentReason());
	}
	...
	return new org.reimagineehr.model.quick.stu3.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getInterpretation());
	}
	...
	public Specimen getSpecimen() {
		return new org.reimagineehr.model.quick.stu3.wrapper.other.SpecimenWrapper((org.hl7.fhir.dstu3.model.Specimen)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getSpecimen()).getResource());
	}

	public void setSpecimen(Specimen arg) {
		this.adaptee.setSpecimen(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.other.SpecimenWrapper)arg).getAdaptee()));
	}
