...
public class ProfessionalQualificationWrapper implements ProfessionalQualification {
	...
	public Organization getIssuer() {
		return new org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper((org.hl7.fhir.dstu3.model.Organization)((org.hl7.fhir.dstu3.model.Reference)this.adaptee.getIssuer()).getResource());
	}

	public void setIssuer(Organization arg) {
		this.adaptee.setIssuer(new org.hl7.fhir.dstu3.model.Reference(((org.reimagineehr.model.quick.stu3.wrapper.party.OrganizationWrapper)arg).getAdaptee()));
	}
