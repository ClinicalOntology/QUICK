...
public class TimingRepeatWrapper implements TimingRepeat {
	...
	public TimeIntervalChoice getBounds() {
		...
		if(type instanceof org.hl7.fhir.dstu3.model.Duration) {
			choice = new org.reimagineehr.model.quick.stu3.wrapper.datatype.DurationWrapper((org.hl7.fhir.dstu3.model.Duration)type);
	...
	public void setBounds(TimeIntervalChoice arg) {
		...
		if(choice.getDuration() != null) {
			this.adaptee.setBounds(((org.reimagineehr.model.quick.stu3.wrapper.datatype.DurationWrapper)choice.getDuration()).getAdaptee());
		}else if(choice.getRange() != null) {
			this.adaptee.setBounds(((org.reimagineehr.model.quick.stu3.wrapper.datatype.RangeWrapper)choice.getRange()).getAdaptee());
		}else if(choice.getPeriod() != null) {
			this.adaptee.setBounds(((org.reimagineehr.model.quick.stu3.wrapper.datatype.PeriodWrapper)choice.getPeriod()).getAdaptee());
		}
	}
