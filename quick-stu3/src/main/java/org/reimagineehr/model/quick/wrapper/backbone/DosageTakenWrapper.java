...
public class DosageTakenWrapper implements DosageTaken {
	...
	return new org.reimagineehr.model.quick.wrapper.datatype.CodeableConceptWrapper(this.adaptee.getSite());
	}
	...
	public SimpleQuantity getDose() {
		...
		return new org.reimagineehr.model.quick.wrapper.datatype.SimpleQuantityWrapper(this.adaptee.getDose());
	}

	public void setDose(SimpleQuantity arg) {
	
		this.adaptee.setDose(((org.reimagineehr.model.quick.wrapper.datatype.SimpleQuantityWrapper)arg).getAdaptee());
	}
	...
	public QuantityRangeRatioOrStringChoice getRate() {
		...
		if(type instanceof org.hl7.fhir.dstu3.model.Ratio) {
			...
			choice = new org.reimagineehr.model.quick.wrapper.datatype.SimpleQuantityWrapper((org.hl7.fhir.dstu3.model.SimpleQuantity)type);
		}
	...
	public void setRate(QuantityRangeRatioOrStringChoice arg) {
		...
		if(choice.getRatio() != null) {
			this.adaptee.setRate(((org.reimagineehr.model.quick.wrapper.datatype.RatioWrapper)choice.getRatio()).getAdaptee());
		}else if(choice.getSimpleQuantity() != null) {
			this.adaptee.setRate(((org.reimagineehr.model.quick.wrapper.datatype.SimpleQuantityWrapper)choice.getSimpleQuantity()).getAdaptee());
		}
	}
